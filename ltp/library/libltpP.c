...
static void	addVImportSession(LtpVspan *vspan, unsigned int sessionNbr,
			Object sessionElt, LtpVImportSession **vsessionPtr)
{
	PsmPartition		ltpwm = getIonwm();
	PsmAddress		addr;
...
void	getImportSession(LtpVspan *vspan, unsigned int sessionNbr,
		LtpVImportSession **vsessionPtr, Object *sessionObj)
{
	Sdr			sdr = getIonsdr();
	PsmPartition		ltpwm = getIonwm();
...
static int	sendFinalRpt(LtpImportSession *session, Object sessionObj,
...
static int	sendReport(LtpImportSession *session, Object sessionObj,
			unsigned int checkpointSerialNbr,
...
static int	startImportSession(Object spanObj, unsigned int sessionNbr,
			LtpImportSession *sessionBuf, Object *sessionObj,
...
static Object	insertCheckpoint(LtpExportSession *session, LtpXmitSeg *segment)
{
	Sdr	sdr = getIonsdr();
	LtpCkpt	checkpoint;
	Object	obj;
...
int	issueSegments(Sdr sdr, LtpSpan *span, LtpVspan *vspan,
		LtpExportSession *session, Object sessionObj, Lyst extents,
...
static void	getSessionContext(LtpDB *ltpdb, unsigned int sessionNbr,
			Object *sessionObj, LtpExportSession *sessionBuf,
