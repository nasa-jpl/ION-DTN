...
B<amsd> { @ | I<MIB_source_name> } { . | @ | I<config_server_endpoint_spec> } [I<registrar_application_name> I<registrar_authority_name> I<registrar_unit_name>]
...
automatically computed as the defaut endpoint specification for the primary
transport service as noted in the MIB: "I<hostname>:2357".

If this B<amsd> task is B<NOT> to run as a registrar then the last three
command-line arguments must be omitted.  Otherwise the last three command-line
