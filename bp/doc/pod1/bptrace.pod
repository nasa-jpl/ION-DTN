...
I<class_of_service> is I<priority>[.I<ordinal>[.I<unreliable>.I<critical>]],
where I<priority> must be 0 (bulk) or 1 (standard) or 2 (expedited), I<ordinal>
must be 0-254, I<unreliable> must be 0 or 1 (Boolean), and I<critical> must
also be 0 or 1 (Boolean).  I<ordinal> is ignored if I<priority> is not 2.
Setting I<class_of_service> to "2.254" gives a bundle the highest possible
priority.  Setting I<unreliable> to 1 causes BP to forego retransmission in
...
I<trace_text> can be any string of ASCII text.
