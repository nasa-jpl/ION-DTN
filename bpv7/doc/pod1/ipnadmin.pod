...
whose IDs conform to the I<ipn> endpoint ID scheme.  Every endpoint ID in the
I<ipn> scheme is a string of the form "ipn:I<node_number>.I<service_number>"
where I<node_number> is a CBHE "node number" and I<service_number> identifies
a specific application processing point.  When I<service_number> is zero,
the endpoint ID constitutes a node ID.  All endpoint IDs formed in the
I<ipn> scheme identify singleton endpoints.
