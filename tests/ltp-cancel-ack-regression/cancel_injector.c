/*
 * cancel_injector.c: Utility to inject LTP Cancel Segments for testing
 *
 * This utility crafts and sends artificial LTP Cancel Segments to test
 * the cancel acknowledgment behavior after sessions are completed.
 *
 * Usage: cancel_injector <segment_type> <dest_host> <dest_port> <source_engine_id> <session_number>
 *   segment_type: CS (12) or CR (14)
 *   dest_host: target host (e.g., localhost)
 *   dest_port: target LTP port
