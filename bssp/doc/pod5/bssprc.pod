...
spans impose flow control on BSSP transmission, reducing the chance of
...
The startup-test command.  Reports whether the BSSP engine is started and sets
...
bsspadmin(1), tcpbsi(1), tcpbso(1), udpbsi(1), udpbso(1)
