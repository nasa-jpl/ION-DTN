...
provided as the sole run-time argument to B<udpclo>.  If this parameter is
omitted the default value is zero, which disables custodial retransmission.
