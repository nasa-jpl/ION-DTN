...
void adm_bp_init_atomic()
{
	...
	adm_add_datadef(ADM_BP_AD_ENDPT_NAMES_MID, DTNMP_TYPE_BLOB,   0, bp_endpoint_get_names,  adm_print_string_list,   adm_size_string_list);
	...
	adm_add_datadef(ADM_BP_AD_ENDPT_NAMES_MID, DTNMP_TYPE_UVAST, 0, NULL,  adm_print_string_list,   adm_size_string_list);
