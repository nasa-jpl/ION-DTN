...
void adm_ion_bp_admin_init_controls()
{
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_OUTDUCT_BLOCK_MID),adm_ion_bp_admin_ctrl_outduct_block);
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_OUTDUCT_UNBLOCK_MID),adm_ion_bp_admin_ctrl_outduct_unblock);
