...
=item int dgr_open(unsigned long ownEngineId, unsigned long clientSvcId, unsigned short ownPortNbr, unsigned int ownIpAddress, char *memmgrName, Dgr *dgr, DgrRC *rc)
