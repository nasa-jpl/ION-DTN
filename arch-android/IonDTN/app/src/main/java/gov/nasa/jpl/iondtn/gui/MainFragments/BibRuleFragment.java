...
import gov.nasa.jpl.iondtn.gui.MainFragments.MainFragmentsAdapters.BibRuleRecyclerViewAdapter;

/**
 * List Configuration Fragment that uses {@link BibRuleRecyclerViewAdapter}
 * to display all configured BibRules
 *
 * @author Robert Wiewel
 */
public class BibRuleFragment extends ConfigurationListFragment {
    private static final String TAG = "BibFrag";
    ...
    protected void launchAddAction() {
        android.support.v4.app.DialogFragment newFragment =
                BibRuleDialogFragment.newInstance();
    ...
    protected void setAdapter() {
        ...
        if (getActivity() instanceof MainActivity) {
            try {
                Bibrule_list = ((MainActivity) getActivity()).getAdminService()
                        .getBibRuleListString();
            }
        ...
        super.mAdapter = new BibRuleRecyclerViewAdapter(
                Bibrule_list, this.getActivity().getSupportFragmentManager());
    }
