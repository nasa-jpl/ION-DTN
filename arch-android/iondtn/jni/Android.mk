...
LOCAL_C_INCLUDES := $(MY_ICI)/include $(MY_ICI)/library $(MY_DGR)/include $(MY_BP)/include $(MY_BP)/library $(MY_BP)/ipn $(MY_BP)/dtn2 $(MY_BP)/crypto $(MY_BP)/ext/bsp $(MY_BP)/ext/ecos
