...
This API is deprecated as of ION 4.1.4-a.2 or later. It returns the Bundle Protocol 
node number identifying this node, as declared when ION was initialized 
by I<ionadmin>. New IPN node numbers should use the getOwnFqnn() API instead.

=item uvast getOwnFqnn()
