...
B<bpsendtest> [-rep I<repetitions>] [-ttl I<ttl>] [-qos I<qos>] I<srcEid> I<destEid> I<fileName>
...
It then creates a bundle from the supplied file identified by I<file_name> 
and sends that bundle a number of times equal to I<repetitions> to the 
endpoint specified by I<desteid>. 
...
be I<srcEid> I<destEid> I<fileName> in their respective order.
