...
=item int sm_rbt_destroy(PsmPartition partition, PsmAddress rbt, SmRbtDeleteFn delete, void *argument);

Destroy an rbt.  Frees each node of the rbt.  If the I<delete> function 
...
and the I<argument> pointer passed to sm_rbt_destroy().  Also frees the rbt
...
=item int sm_rbt_delete(PsmPartition partition, PsmAddress rbt, SmRbtCompareFn compare, void *dataBuffer, SmRbtDeleteFn delete, void *argument);
