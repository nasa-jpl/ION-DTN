...
used for the storage of bundles.  A value of -1 for either limit signifies
"leave unchanged".  The default heap limit is 60% of the SDR data store's
total heap size.  The default file system limit is 1 Terabyte.
