...
B<ramsgate> will communicate with other RAMS gateway modules in other
...
modules in other continua) in a file whose name is the venture number
followed by ".petition.log" (e.g., "1.petition.log").  At startup,
