...
"vmq", and "tcp" are all available in the array, a I<tsorder> string of "12" 
would indicate that this application will only communicate using the dgr
and vmq service; services 0 (udp) and 3 (tcp) will not be used.
