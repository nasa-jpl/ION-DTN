...
the best-efforts and/or reliable "segments ready" semaphores are given if the
corresponding outbound segment queues are non-empty (enabling transmission of
...
Then B<bsspclock> enqueues for reliable transmission all segments for which
