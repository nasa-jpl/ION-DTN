...
B<ltpdriver> I<nbrOfCycles> I<remote_engine_nbr> [I<length>]

=head1 DESCRIPTION

B<ltpdriver> uses LTP to send I<nbrOfCycles> service data units of length
indicated by I<length>, flagged with client service number 1, to the
B<ltpcounter> client service process attached to the remote LTP engine
identified by I<remote_engine_nbr>.  If omitted, I<length> defaults to
