...
B<cgrfetch> { [I<OPTIONS>] I<DEST-NODE> } | -l
...
The second form of the command can be used to list all valid outducts.
...
List all valid outducts instead of performing CGR simulation.
