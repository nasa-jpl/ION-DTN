...
B<$>	bundle's custodial retransmission timeout interval expired
...
retained for backward compatibility.  The I<endpoint_name> identifying
...
=item B<d planduct> I<endpoint_name> I<protocol_name> I<duct_name>
...
transmitting bundles to the node[s] identified by I<endpoint_name>.
