...
tnv_t *adm_ltp_agent_meta_name(tnvc_t *parms)
{
	return tnv_from_str("adm_ltp_agent");
}


tnv_t *adm_ltp_agent_meta_namespace(tnvc_t *parms)
{
	return tnv_from_str("arn:DTN:ltp_agent");
}


tnv_t *adm_ltp_agent_meta_version(tnvc_t *parms)
{
	return tnv_from_str("V0.0");
}


tnv_t *adm_ltp_agent_meta_organization(tnvc_t *parms)
{
 ...
 */
tnv_t *adm_ltp_agent_get_span_remote_engine_nbr(tnvc_t *parms)
{
 ...
 */
tnv_t *adm_ltp_agent_get_span_cur_expt_sess(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_cur_out_seg(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_cur_imp_sess(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_cur_in_seg(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_reset_time(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_out_seg_q_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_out_seg_q_bytes(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_out_seg_pop_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_out_seg_pop_bytes(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_out_ckpt_xmit_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_out_pos_ack_rx_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_out_neg_ack_rx_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_out_cancel_rx_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_out_ckpt_rexmit_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_out_cancel_xmit_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_out_complete_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_rx_red_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_rx_red_bytes(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_rx_green_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_rx_green_bytes(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_rx_redundant_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_rx_redundant_bytes(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_rx_mal_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_rx_mal_bytes(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_rx_unk_sender_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_rx_unk_sender_bytes(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_rx_unk_client_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_rx_unk_client_bytes(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_stray_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_stray_bytes(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_miscolor_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_miscolor_bytes(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_closed_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_seg_closed_bytes(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_ckpt_rx_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_pos_ack_tx_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_neg_ack_tx_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_cancel_tx_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_ack_retx_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_cancel_rx_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_get_span_in_complete_cnt(tnvc_t *parms)
{
	tnv_t *result = tnv_create();
	/*
	 * +-------------------------------------------------------------------------+
 ...
 */
tnv_t *adm_ltp_agent_ctrl_reset(eid_t *def_mgr, tnvc_t *parms, int8_t *status)
{
	tnv_t *result = tnv_create();
	*status = CTRL_FAILURE;
	/*
