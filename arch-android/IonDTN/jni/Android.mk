...
LOCAL_CFLAGS = -g -Werror -Wall -Wno-unused-variable -Wno-int-to-pointer-cast -Dbionic -DBP_EXTENDED -DGDSSYMTAB -DUSING_SDR_POINTERS -DNO_SDR_TRACE -DNO_PSM_TRACE -DENABLE_IMC -DBPSEC -DAGENT_ROLE
#	-DENABLE_ACS -DNO_PROXY -DNO_DIRLIST

LOCAL_LDLIBS :=  -llog

LOCAL_SRC_FILES := iondtn_administration.c iondtn_transmission.c iondtn_listinfo.cpp gdslogger.c $(MY_ICISOURCES) $(MY_DGRSOURCES) $(MY_BPSOURCES) $(MY_BPSECSOURCES) $(MY_NMSOURCES) $(MY_BSSSOURCES)
