...
{
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_INIT_MID,adm_ion_admin_ctrl_node_init);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CLOCK_ERROR_SET_MID,adm_ion_admin_ctrl_node_clock_error_set);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CLOCK_SYNC_SET_MID,adm_ion_admin_ctrl_node_clock_sync_set);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CONGESTION_ALARM_CONTROL_SET_MID,adm_ion_admin_ctrl_node_congestion_alarm_control_set);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CONGESTION_END_TIME_FORECASTS_SET_MID,adm_ion_admin_ctrl_node_congestion_end_time_forecasts_set);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CONSUMPTION_RATE_SET_MID,adm_ion_admin_ctrl_node_consumption_rate_set);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CONTACT_ADD_MID,adm_ion_admin_ctrl_node_contact_add);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CONTACT_DEL_MID,adm_ion_admin_ctrl_node_contact_del);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_INBOUND_HEAP_OCCUPANCY_LIMIT_SET_MID,adm_ion_admin_ctrl_node_inbound_heap_occupancy_limit_set);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_OUTBOUND_HEAP_OCCUPANCY_LIMIT_SET_MID,adm_ion_admin_ctrl_node_outbound_heap_occupancy_limit_set);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_PRODUCTION_RATE_SET_MID,adm_ion_admin_ctrl_node_production_rate_set);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_RANGE_ADD_MID,adm_ion_admin_ctrl_node_range_add);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_RANGE_DEL_MID,adm_ion_admin_ctrl_node_range_del);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_REF_TIME_SET_MID,adm_ion_admin_ctrl_node_ref_time_set);
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_UTC_DELTA_SET_MID,adm_ion_admin_ctrl_node_utc_delta_set);
}
