...
B<psmwatch> I<partition_name> I<interval> I<count> [ verbose ]
...
memory management activity in the PSM-managed memory partition identified
by I<partition_name> during that interval.  If the optional B<verbose>
parameter is specified, the printed PSM activity trace will be verbose
as described in psm(3).
