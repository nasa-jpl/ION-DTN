...
{
	adm_add_edd(ADM_ION_ADMIN_EDD_CLOCK_ERROR_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	names_add_name("CLOCK_ERROR", "This is how accurate the ION Agent's clock is.", ADM_ION_ADMIN, ADM_ION_ADMIN_EDD_CLOCK_ERROR_MID);

	adm_add_edd(ADM_ION_ADMIN_EDD_CLOCK_SYNC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_ION_ADMIN_EDD_CONGESTION_ALARM_CONTROL_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_ION_ADMIN_EDD_CONGESTION_END_TIME_FORECASTS_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_ION_ADMIN_EDD_CONSUMPTION_RATE_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_ION_ADMIN_EDD_INBOUND_FILE_SYSTEM_OCCUPANCY_LIMIT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_ION_ADMIN_EDD_INBOUND_HEAP_OCCUPANCY_LIMIT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_ION_ADMIN_EDD_NUMBER_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_ION_ADMIN_EDD_OUTBOUND_FILE_SYSTEM_OCCUPANCY_LIMIT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_ION_ADMIN_EDD_OUTBOUND_HEAP_OCCUPANCY_LIMIT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_ION_ADMIN_EDD_PRODUCTION_RATE_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_ION_ADMIN_EDD_REF_TIME_MID, AMP_TYPE_TS, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_ION_ADMIN_EDD_UTC_DELTA_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_ION_ADMIN_EDD_VERSION_MID, AMP_TYPE_STR, 0, NULL, NULL, NULL);
...
{
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_INIT_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CLOCK_ERROR_SET_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CLOCK_SYNC_SET_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CONGESTION_ALARM_CONTROL_SET_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CONGESTION_END_TIME_FORECASTS_SET_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CONSUMPTION_RATE_SET_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CONTACT_ADD_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_CONTACT_DEL_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_INBOUND_HEAP_OCCUPANCY_LIMIT_SET_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_OUTBOUND_HEAP_OCCUPANCY_LIMIT_SET_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_PRODUCTION_RATE_SET_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_RANGE_ADD_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_RANGE_DEL_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_REF_TIME_SET_MID, NULL);
	...
	adm_add_ctrl(ADM_ION_ADMIN_CTRL_NODE_UTC_DELTA_SET_MID, NULL);
...
void adm_ion_admin_init_metadata()
{
	...
	adm_add_edd(ADM_ION_ADMIN_META_NAME_MID, AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("NAME", "The human-readable name of the ADM.", ADM_ION_ADMIN, ADM_ION_ADMIN_META_NAME_MID);
	adm_add_edd(ADM_ION_ADMIN_META_NAMESPACE_MID, AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("NAMESPACE", "The namespace of the ADM.", ADM_ION_ADMIN, ADM_ION_ADMIN_META_NAMESPACE_MID);
	adm_add_edd(ADM_ION_ADMIN_META_VERSION_MID, AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("VERSION", "The version of the ADM.", ADM_ION_ADMIN, ADM_ION_ADMIN_META_VERSION_MID);
	adm_add_edd(ADM_ION_ADMIN_META_ORGANIZATION_MID, AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
