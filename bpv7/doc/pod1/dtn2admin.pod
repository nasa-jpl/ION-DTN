...
whose IDs conform to the I<dtn> endpoint ID scheme.  Endpoint IDs in the
I<dtn> scheme are strings of the form "dtn://I<node_name>/[[~]I<demux_token>]",
where I<node_name> identifies a BP node (often this is the DNS name of the
computer on which the node resides) and I<demux_token> normally identifies a
...
I<dtn> endpoint ID scheme imposes more transmission overhead than the
