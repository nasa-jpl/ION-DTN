...
LABEL org.opencontainers.image.title="ubuntu-24"
LABEL org.opencontainers.image.description="A Ubuntu 24.04 base image for ION testing, includes all necessary ARC and ION build dependencies."
