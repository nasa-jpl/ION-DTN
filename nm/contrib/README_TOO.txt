...
This document highlights modifications made to correct NM Manager database connection errors in ION 4.1.1 (and the related amp-sql-1.0.tar.gz). Persuant to these changes the amp-sql directory has tentatively been renamed to amp-sql-1.0.1 to reflect the modifications.
