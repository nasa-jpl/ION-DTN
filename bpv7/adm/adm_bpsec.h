...
extern vec_idx_t g_dtn_bpsec_idx[11];
 ...
 * +---------------------+--------------+--------------------------------------+-------+------------------------+
 * |name                 |448018d200    |The human-readable name of the ADM.   |STR    |bpsec                    |
 * +---------------------+--------------+--------------------------------------+-------+------------------------+
 * |namespace            |448018d201    |The namespace of the ADM.             |STR    |DTN/bpsec                |
 * +---------------------+--------------+--------------------------------------+-------+------------------------+
 ...
 * +---------------------+--------------+--------------------------------------+-------+
 * |last_update          |458218ca1819  |Last bpsec update                      |TV     |
 * +---------------------+--------------+--------------------------------------+-------+
 ...
 * +---------------------+--------------+--------------------------------------+-------+
 * |last_update_src      |45c218ca1836  |Last bpsec update from SRC             |TV     |
 * +---------------------+--------------+--------------------------------------+-------+
 ...
 * +---------------------+--------------+--------------------------------------+-------+
 */
#define DTN_BPSEC_TBLT_BIB_RULES 0x00
#define DTN_BPSEC_TBLT_BCB_RULES 0x01
 ...
 * |                     |              |et Time of the bpsec EDD data to the ti|       |
 ...
 * |                     |              |sp system.                            |       |
 * +---------------------+--------------+--------------------------------------+-------+
 * |add_key              |44c118c903    |This control adds a key to the bpsec sy|       |
 * |                     |              |stem.                                 |       |
 * +---------------------+--------------+--------------------------------------+-------+
 * |add_bib_rule         |44c118c904    |This control configures policy on the |       |
 * |                     |              |bpsec protocol implementation that desc|       |
 ...
 * |                     |              |licy on the bpsec protocol implementati|       |
