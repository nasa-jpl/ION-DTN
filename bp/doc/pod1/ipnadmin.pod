...
form "ipn:I<element_number>.I<service_number>" where I<element_number> is
an ION "node number" and I<service_number> identifies a specific application
processing point.
...
=item ipnadmin host1.ipn

Execute all configuration commands in I<host1.ipn>, then terminate immediately.
