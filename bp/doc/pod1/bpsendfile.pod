...
B<bpsendfile> I<own_endpoint_ID> I<destination_endpoint_ID> I<file_name> [I<time_to_live (seconds)> [I<class_of_service>]]
...
requested; I<time_to_live>, if not specified, defaults to 300 seconds (5
minutes).  When I<class_of_service> is omitted, the bundle is sent at standard
priority; for details of the I<class_of_service> parameter, see bptrace(1).
