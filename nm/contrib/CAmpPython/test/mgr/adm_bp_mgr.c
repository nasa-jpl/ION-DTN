...
void adm_bp_init_reports()
{
	...
	cur_mid = mid_from_value(ADM_BP_META_NAME_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_META_VERSION_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_BP_NODE_ID_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_BP_NODE_VERSION_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_AVAILABLE_STORAGE_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_LAST_RESET_TIME_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_NUM_REGISTRATIONS_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_NUM_PEND_FWD_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_NUM_PEND_DIS_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_NUM_IN_CUST_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_NUM_PEND_REASSEMBLY_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);
	...
	cur_mid = mid_from_value(ADM_BP_EDD_NUM_FRAGMENTED_BUNDLES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_NUM_FRAGMENTS_PRODUCED_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);
	...
	cur_mid = mid_from_value(ADM_BP_EDD_NUM_BUNDLES_DELETED_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_FAILED_CUSTODY_BUNDLES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_FAILED_CUSTODY_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_FAILED_FORWARD_BUNDLES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_FAILED_FORWARD_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_ABANDONED_BUNDLES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_DISCARDED_BUNDLES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_DISCARDED_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BP_EDD_ENDPOINT_NAMES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	midcol_destroy(&rpt);

	names_add_name("FULL_REPORT", "This is all known meta-data, EDD, and VAR values known by the agent.", ADM_BP, ADM_BP_RPT_FULL_REPORT_MID);
rpt = lyst_create();
