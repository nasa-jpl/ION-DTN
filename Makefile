...
am__libbp_la_SOURCES_DIST = bp/library/libbp.c bp/library/libbpP.c \
	...
	bp/library/bei.c bp/library/ext/bae/bae.c \
	bp/library/ext/bsp/extbsputil.c bp/library/ext/bsp/extbspbab.c \
	bp/library/ext/bsp/extbsppcb.c bp/library/ext/bsp/extbsppib.c \
	...
	bp/library/ext/cteb/cteb.c bp/imc/libimcfw.c
#am__objects_1 =  \
#	bp/library/crypto/NULL_SUITES/libbp_la-crypto.lo
am__objects_2 = bp/library/crypto/NULL_SUITES/libbp_la-crypto.lo
...
am_libbp_la_OBJECTS = bp/library/libbp_la-libbp.lo \
	...
	bp/library/libbp_la-bei.lo bp/library/ext/bae/libbp_la-bae.lo \
	bp/library/ext/bsp/libbp_la-extbsputil.lo \
	bp/library/ext/bsp/libbp_la-extbspbab.lo \
	bp/library/ext/bsp/libbp_la-extbsppcb.lo \
	bp/library/ext/bsp/libbp_la-extbsppib.lo $(am__objects_1) \
...
libbp_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	...
	$(CFLAGS) $(libbp_la_LDFLAGS) $(LDFLAGS) -o $@
libbss_la_DEPENDENCIES = libici.la libbp.la $(am__DEPENDENCIES_1)
...
libbss_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	...
	$(CFLAGS) $(libbss_la_LDFLAGS) $(LDFLAGS) -o $@
libbssfw_la_DEPENDENCIES = libbp.la libici.la
am_libbssfw_la_OBJECTS = bp/bss/libbssfw_la-libbssfw.lo
libbssfw_la_OBJECTS = $(am_libbssfw_la_OBJECTS)
libbssfw_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(libbssfw_la_CFLAGS) \
	$(CFLAGS) $(libbssfw_la_LDFLAGS) $(LDFLAGS) -o $@
...
am__EXEEXT_1 = sdrwatch$(EXEEXT) psmwatch$(EXEEXT) ionadmin$(EXEEXT) \
	...
	smlistsh$(EXEEXT) rfxclock$(EXEEXT) owlttb$(EXEEXT) \
	owltsim$(EXEEXT)
...
am__EXEEXT_6 = bpadmin$(EXEEXT) bpsink$(EXEEXT) bpdriver$(EXEEXT) \
	...
	bssadmin$(EXEEXT) ipnfw$(EXEEXT) bssfw$(EXEEXT) \
	ipnadminep$(EXEEXT) dtn2admin$(EXEEXT) dtn2fw$(EXEEXT) \
	dtn2adminep$(EXEEXT) tcpcli$(EXEEXT) tcpclo$(EXEEXT) \
	stcpcli$(EXEEXT) stcpclo$(EXEEXT) brsscla$(EXEEXT) \
	brsccla$(EXEEXT) udpcli$(EXEEXT) udpclo$(EXEEXT) \
	dccpcli$(EXEEXT) dccpclo$(EXEEXT) dgrcla$(EXEEXT) \
...
am__EXEEXT_8 = ionrestart$(EXEEXT)
am__EXEEXT_9 = amsd$(EXEEXT) amshello$(EXEEXT) \
	amsshell$(EXEEXT) amslog$(EXEEXT) \
	amslogprt$(EXEEXT) amsbenchs$(EXEEXT) \
	amsbenchr$(EXEEXT) amsstop$(EXEEXT) \
	ramsgate$(EXEEXT)
am__EXEEXT_10 = cfdpadmin$(EXEEXT) \
	cfdpclock$(EXEEXT) bputa$(EXEEXT) \
	cfdptest$(EXEEXT) bpcp$(EXEEXT) \
	bpcpd$(EXEEXT)
am__EXEEXT_11 = $(am__EXEEXT_9) $(am__EXEEXT_10)
am__EXEEXT_12 = tests/issue-330-cfdpclock-FDU-removal/cfdplisten$(EXEEXT) \
...
brsccla_DEPENDENCIES = libipnfw.la libbssfw.la libdtn2fw.la libbp.la \
	libtcpcla.la libici.la $(LIBOBJS) $(am__DEPENDENCIES_1)
...
brsscla_DEPENDENCIES = libipnfw.la libbssfw.la libdtn2fw.la libbp.la \
	libtcpcla.la libici.la $(LIBOBJS) $(am__DEPENDENCIES_1)
...
bssStreamingApp_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC \
	...
	-o $@
am_bssadmin_OBJECTS = bp/bss/bssadmin-bssadmin.$(OBJEXT)
bssadmin_OBJECTS = $(am_bssadmin_OBJECTS)
bssadmin_DEPENDENCIES = libbssfw.la libbp.la libici.la $(LIBOBJS)
bssadmin_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(bssadmin_CFLAGS) \
	$(CFLAGS) $(AM_LDFLAGS) $(LDFLAGS) -o $@
...
bssdriver_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	...
	$(CFLAGS) $(AM_LDFLAGS) $(LDFLAGS) -o $@
am_bssfw_OBJECTS = bp/bss/bssfw-bssfw.$(OBJEXT)
bssfw_OBJECTS = $(am_bssfw_OBJECTS)
bssfw_DEPENDENCIES = libbssfw.la libcgr.la libbp.la libici.la \
	$(LIBOBJS)
bssfw_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(bssfw_CFLAGS) $(CFLAGS) \
	$(AM_LDFLAGS) $(LDFLAGS) -o $@
...
cfdptest_DEPENDENCIES = libcfdp.la libici.la \
	libbp.la $(LIBOBJS) $(am__DEPENDENCIES_1)
...
dccpcli_DEPENDENCIES = libipnfw.la libbssfw.la libdtn2fw.la libbp.la \
	libici.la $(LIBOBJS) $(am__DEPENDENCIES_1)
...
dgrcla_DEPENDENCIES = libipnfw.la libbssfw.la libdtn2fw.la libbp.la \
	libdgr.la libici.la $(LIBOBJS) $(am__DEPENDENCIES_1)
...
ltpcli_DEPENDENCIES = libipnfw.la libbssfw.la libdtn2fw.la libbp.la \
	libltp.la libici.la $(LIBOBJS) $(am__DEPENDENCIES_1)
...
owltsim_DEPENDENCIES = libici.la $(LIBOBJS) $(am__DEPENDENCIES_1)
...
owlttb_DEPENDENCIES = libici.la $(LIBOBJS) $(am__DEPENDENCIES_1)
...
stcpcli_DEPENDENCIES = libipnfw.la libbssfw.la libdtn2fw.la libbp.la \
	libtcpcla.la libici.la $(LIBOBJS) $(am__DEPENDENCIES_1)
...
tcpcli_DEPENDENCIES = libipnfw.la libbssfw.la libdtn2fw.la libbp.la \
	libtcpcla.la libici.la $(LIBOBJS) $(am__DEPENDENCIES_1)
...
tests_1400_loopback_stcp_dotest_DEPENDENCIES = libbp.la libici.la \
	$(ltplib) $(LIBOBJS) $(TESTUTILOBJS)
tests_1400_loopback_stcp_dotest_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC \
	$(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link $(CCLD) \
...
udpcli_DEPENDENCIES = libipnfw.la libbssfw.la libdtn2fw.la libbp.la \
	libudpcla.la libici.la $(LIBOBJS) $(am__DEPENDENCIES_1)
...
SOURCES = $(libams_la_SOURCES) $(libbp_la_SOURCES) \
	$(libbss_la_SOURCES) $(libbssfw_la_SOURCES) \
	...
	$(bssStreamingApp_SOURCES) $(bssadmin_SOURCES) \
	$(bsscounter_SOURCES) $(bssdriver_SOURCES) $(bssfw_SOURCES) \
	$(bssrecv_SOURCES) $(cfdpadmin_SOURCES) $(cfdpclock_SOURCES) \
	$(cfdptest_SOURCES) $(cgrfetch_SOURCES) $(dccpcli_SOURCES) \
	...
	$(ltpmeter_SOURCES) $(owltsim_SOURCES) $(owlttb_SOURCES) \
	$(psmshell_SOURCES) $(psmwatch_SOURCES) $(ramsgate_SOURCES) \
	$(rfxclock_SOURCES) $(sdr2file_SOURCES) $(sdrmend_SOURCES) \
...
DIST_SOURCES = $(am__libams_la_SOURCES_DIST) \
	...
	$(libbssfw_la_SOURCES) $(am__libcfdp_la_SOURCES_DIST) \
	$(libcgr_la_SOURCES) $(libdgr_la_SOURCES) \
	$(libdtn2fw_la_SOURCES) $(libici_la_SOURCES) \
	...
	$(bptrace_SOURCES) $(am__bputa_SOURCES_DIST) \
	$(brsccla_SOURCES) $(brsscla_SOURCES) \
	$(bssStreamingApp_SOURCES) $(bssadmin_SOURCES) \
	$(bsscounter_SOURCES) $(bssdriver_SOURCES) $(bssfw_SOURCES) \
	$(bssrecv_SOURCES) $(am__cfdpadmin_SOURCES_DIST) \
	$(am__cfdpclock_SOURCES_DIST) $(am__cfdptest_SOURCES_DIST) \
	...
	$(dtn2fw_SOURCES) $(file2dgr_SOURCES) $(file2sdr_SOURCES) \
	...
	$(ionexit_SOURCES) $(am__ionrestart_SOURCES_DIST) \
...
am__include_HEADERS_DIST = ici/include/llcv.h ici/include/platform.h \
	...
	ltp/include/ltp.h dgr/include/dgr.h bp/include/bp.h \
	bss/include/bss.h ams/include/ams.h cfdp/include/cfdp.h \
...
am__noinst_HEADERS_DIST = ici/library/lystP.h ici/sdr/sdrP.h \
	...
	bp/ipn/ipnfw.h bp/bss/bssfw.h bp/dtn2/dtn2fw.h bp/brs/brscla.h \
	bp/udp/udpcla.h bp/ltp/ltpcla.h bp/tcp/tcpcla.h \
	bp/dccp/dccpcla.h bss/library/bssP.h ams/library/amscommon.h \
...
ACLOCAL = ${SHELL} /Users/mick/ion-open-source/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /Users/mick/ion-open-source/missing autoconf
AUTOHEADER = ${SHELL} /Users/mick/ion-open-source/missing autoheader
AUTOMAKE = ${SHELL} /Users/mick/ion-open-source/missing automake-1.14
AWK = awk
CC = /usr/local/bin/gcc-4.9
CCDEPMODE = depmode=gcc3
CFLAGS = -DENABLE_IMC -DENABLE_BPACS -O0 -g -Wno-error
CPP = /usr/local/bin/gcc-4.9 -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
...
ION_CFLAGS =  -Dunix -Ddarwin -DSPACE_ORDER=3 -m64 
ION_LINK_FLAGS =  -dynamiclib -undefined dynamic_lookup
LD = /opt/local/bin/ld
LDFLAGS = 
LIBOBJS = 
LIBS = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/mick/ion-open-source/missing makeinfo
MANIFEST_TOOL = :
MANOPTS = 
...
PACKAGE_NAME = ion
PACKAGE_STRING = ion open source 3.1.2
PACKAGE_TARNAME = ion
PACKAGE_URL = 
PACKAGE_VERSION = open source 3.1.2
PATH_SEPARATOR = :
PDF2PS = /usr/local/bin/pdf2ps
POD_DOCUMENTATION = pod2man
PS2PDF = /usr/local/bin/ps2pdf
PSJOIN = /Users/mick/ion-open-source/doc/psjoin
...
VERSION = open source 3.1.2
abs_builddir = /Users/mick/ion-open-source
abs_srcdir = /Users/mick/ion-open-source
abs_top_builddir = /Users/mick/ion-open-source
abs_top_srcdir = /Users/mick/ion-open-source
ac_ct_AR = ar
...
install_sh = ${SHELL} /Users/mick/ion-open-source/install-sh
...
AM_CFLAGS = $(ION_CFLAGS) -Wall -Werror -g -include config.h \
	...
	-I$(srcdir)/bss/include $(am__append_1) \
	$(VALGRIND_COMPAT_CFLAGS)
...
EXTRA_DIST = $(srcdir)/loopbacktest.sh $(srcdir)/sysctl_script.sh \
	...
	$(ltpextra) $(dgrextra) $(bpextra) $(bssextra) $(am__append_2)
lib_LTLIBRARIES = $(icilib) $(ltplib) $(dgrlib) $(bplib) $(bsslib) \
	$(am__append_4)
include_HEADERS = $(iciinclude) $(ltpinclude) $(dgrinclude) \
	$(bpinclude) $(bssinclude) $(am__append_5)
noinst_HEADERS = $(icinoinst) $(ltpnoinst) $(dgrnoinst) $(bpnoinst) \
	$(bssnoinst) $(am__append_6)
man_MANS = build-man-directories $(icimans) $(ltpmans) $(dgrmans) \
	$(bpmans) $(bssmans) $(am__append_7)
...
bpbin = bpadmin bpsink bpdriver bpsource bpecho bpcancel bpcounter \
	bplist bpsendfile bprecvfile bpclock ipnadmin bssadmin ipnfw \
	bssfw ipnadminep dtn2admin dtn2fw dtn2adminep tcpcli tcpclo \
	stcpcli stcpclo brsscla brsccla udpcli udpclo dccpcli dccpclo \
	dgrcla ltpcli ltpclo lgsend lgagent bptrace bping bpstats \
	bpstats2 bpchat hmackeys cgrfetch $(am__append_8) \
	$(am__append_9)
bplib = \
	libbp.la \
	libcgr.la \
...
bpmans = $(top_builddir)/bp/doc/bpadmin.1 \
	...
	$(top_builddir)/bp/doc/ipnfw.1 $(top_builddir)/bp/doc/bssfw.1 \
...
bp/library/ext/bsp/libbp_la-extbsppcb.lo:  \
	bp/library/ext/bsp/$(am__dirstamp) \
	bp/library/ext/bsp/$(DEPDIR)/$(am__dirstamp)
bp/library/ext/bsp/libbp_la-extbsppib.lo:  \
	bp/library/ext/bsp/$(am__dirstamp) \
	bp/library/ext/bsp/$(DEPDIR)/$(am__dirstamp)
...
bp/bss/$(am__dirstamp):
	@$(MKDIR_P) bp/bss
	@: > bp/bss/$(am__dirstamp)
bp/bss/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) bp/bss/$(DEPDIR)
	@: > bp/bss/$(DEPDIR)/$(am__dirstamp)
bp/bss/libbssfw_la-libbssfw.lo: bp/bss/$(am__dirstamp) \
	bp/bss/$(DEPDIR)/$(am__dirstamp)

libbssfw.la: $(libbssfw_la_OBJECTS) $(libbssfw_la_DEPENDENCIES) $(EXTRA_libbssfw_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(libbssfw_la_LINK) -rpath $(libdir) $(libbssfw_la_OBJECTS) $(libbssfw_la_LIBADD) $(LIBS)
...
bp/bss/bssadmin-bssadmin.$(OBJEXT): bp/bss/$(am__dirstamp) \
	bp/bss/$(DEPDIR)/$(am__dirstamp)

bssadmin$(EXEEXT): $(bssadmin_OBJECTS) $(bssadmin_DEPENDENCIES) $(EXTRA_bssadmin_DEPENDENCIES) 
	@rm -f bssadmin$(EXEEXT)
	$(AM_V_CCLD)$(bssadmin_LINK) $(bssadmin_OBJECTS) $(bssadmin_LDADD) $(LIBS)
...
bp/bss/bssfw-bssfw.$(OBJEXT): bp/bss/$(am__dirstamp) \
	bp/bss/$(DEPDIR)/$(am__dirstamp)

bssfw$(EXEEXT): $(bssfw_OBJECTS) $(bssfw_DEPENDENCIES) $(EXTRA_bssfw_DEPENDENCIES) 
	@rm -f bssfw$(EXEEXT)
	$(AM_V_CCLD)$(bssfw_LINK) $(bssfw_OBJECTS) $(bssfw_LDADD) $(LIBS)
...
tests/1400.loopback-stcp/dotest$(EXEEXT): $(tests_1400_loopback_stcp_dotest_OBJECTS) $(tests_1400_loopback_stcp_dotest_DEPENDENCIES) $(EXTRA_tests_1400_loopback_stcp_dotest_DEPENDENCIES) tests/1400.loopback-stcp/$(am__dirstamp)
	@rm -f tests/1400.loopback-stcp/dotest$(EXEEXT)
	$(AM_V_CCLD)$(tests_1400_loopback_stcp_dotest_LINK) $(tests_1400_loopback_stcp_dotest_OBJECTS) $(tests_1400_loopback_stcp_dotest_LDADD) $(LIBS)
...
mostlyclean-compile:
	...
	-rm -f bp/library/crypto/NULL_SUITES/*.$(OBJEXT)
	-rm -f bp/library/crypto/NULL_SUITES/*.lo
	...
	-rm -f tests/1400.loopback-stcp/*.$(OBJEXT)
...
include bp/bss/$(DEPDIR)/bssadmin-bssadmin.Po
include bp/bss/$(DEPDIR)/bssfw-bssfw.Po
include bp/bss/$(DEPDIR)/libbssfw_la-libbssfw.Plo
...
include bp/library/ext/bsp/$(DEPDIR)/libbp_la-extbsppcb.Plo
include bp/library/ext/bsp/$(DEPDIR)/libbp_la-extbsppib.Plo
...
bp/library/ext/bsp/libbp_la-extbsputil.lo: bp/library/ext/bsp/extbsputil.c
	...
	$(AM_V_at)$(am__mv) bp/library/ext/bsp/$(DEPDIR)/libbp_la-extbsputil.Tpo bp/library/ext/bsp/$(DEPDIR)/libbp_la-extbsputil.Plo
#	$(AM_V_CC)source='bp/library/ext/bsp/extbsputil.c' object='bp/library/ext/bsp/libbp_la-extbsputil.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bsp/libbp_la-extbsputil.lo `test -f 'bp/library/ext/bsp/extbsputil.c' || echo '$(srcdir)/'`bp/library/ext/bsp/extbsputil.c
...
bp/library/ext/bsp/libbp_la-extbspbab.lo: bp/library/ext/bsp/extbspbab.c
	...
	$(AM_V_at)$(am__mv) bp/library/ext/bsp/$(DEPDIR)/libbp_la-extbspbab.Tpo bp/library/ext/bsp/$(DEPDIR)/libbp_la-extbspbab.Plo
#	$(AM_V_CC)source='bp/library/ext/bsp/extbspbab.c' object='bp/library/ext/bsp/libbp_la-extbspbab.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bsp/libbp_la-extbspbab.lo `test -f 'bp/library/ext/bsp/extbspbab.c' || echo '$(srcdir)/'`bp/library/ext/bsp/extbspbab.c

bp/library/ext/bsp/libbp_la-extbsppcb.lo: bp/library/ext/bsp/extbsppcb.c
	...
	$(AM_V_at)$(am__mv) bp/library/ext/bsp/$(DEPDIR)/libbp_la-extbsppcb.Tpo bp/library/ext/bsp/$(DEPDIR)/libbp_la-extbsppcb.Plo
#	$(AM_V_CC)source='bp/library/ext/bsp/extbsppcb.c' object='bp/library/ext/bsp/libbp_la-extbsppcb.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bsp/libbp_la-extbsppcb.lo `test -f 'bp/library/ext/bsp/extbsppcb.c' || echo '$(srcdir)/'`bp/library/ext/bsp/extbsppcb.c

bp/library/ext/bsp/libbp_la-extbsppib.lo: bp/library/ext/bsp/extbsppib.c
	...
	$(AM_V_at)$(am__mv) bp/library/ext/bsp/$(DEPDIR)/libbp_la-extbsppib.Tpo bp/library/ext/bsp/$(DEPDIR)/libbp_la-extbsppib.Plo
#	$(AM_V_CC)source='bp/library/ext/bsp/extbsppib.c' object='bp/library/ext/bsp/libbp_la-extbsppib.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bsp/libbp_la-extbsppib.lo `test -f 'bp/library/ext/bsp/extbsppib.c' || echo '$(srcdir)/'`bp/library/ext/bsp/extbsppib.c
...
bp/library/crypto/NULL_SUITES/libbp_la-crypto.lo: bp/library/crypto/NULL_SUITES/crypto.c
	...
	$(AM_V_at)$(am__mv) bp/library/crypto/NULL_SUITES/$(DEPDIR)/libbp_la-crypto.Tpo bp/library/crypto/NULL_SUITES/$(DEPDIR)/libbp_la-crypto.Plo
#	$(AM_V_CC)source='bp/library/crypto/NULL_SUITES/crypto.c' object='bp/library/crypto/NULL_SUITES/libbp_la-crypto.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
bp/bss/libbssfw_la-libbssfw.lo: bp/bss/libbssfw.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbssfw_la_CFLAGS) $(CFLAGS) -MT bp/bss/libbssfw_la-libbssfw.lo -MD -MP -MF bp/bss/$(DEPDIR)/libbssfw_la-libbssfw.Tpo -c -o bp/bss/libbssfw_la-libbssfw.lo `test -f 'bp/bss/libbssfw.c' || echo '$(srcdir)/'`bp/bss/libbssfw.c
	$(AM_V_at)$(am__mv) bp/bss/$(DEPDIR)/libbssfw_la-libbssfw.Tpo bp/bss/$(DEPDIR)/libbssfw_la-libbssfw.Plo
#	$(AM_V_CC)source='bp/bss/libbssfw.c' object='bp/bss/libbssfw_la-libbssfw.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbssfw_la_CFLAGS) $(CFLAGS) -c -o bp/bss/libbssfw_la-libbssfw.lo `test -f 'bp/bss/libbssfw.c' || echo '$(srcdir)/'`bp/bss/libbssfw.c
...
bp/bss/bssadmin-bssadmin.o: bp/bss/bssadmin.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(bssadmin_CFLAGS) $(CFLAGS) -MT bp/bss/bssadmin-bssadmin.o -MD -MP -MF bp/bss/$(DEPDIR)/bssadmin-bssadmin.Tpo -c -o bp/bss/bssadmin-bssadmin.o `test -f 'bp/bss/bssadmin.c' || echo '$(srcdir)/'`bp/bss/bssadmin.c
	$(AM_V_at)$(am__mv) bp/bss/$(DEPDIR)/bssadmin-bssadmin.Tpo bp/bss/$(DEPDIR)/bssadmin-bssadmin.Po
#	$(AM_V_CC)source='bp/bss/bssadmin.c' object='bp/bss/bssadmin-bssadmin.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(bssadmin_CFLAGS) $(CFLAGS) -c -o bp/bss/bssadmin-bssadmin.o `test -f 'bp/bss/bssadmin.c' || echo '$(srcdir)/'`bp/bss/bssadmin.c

bp/bss/bssadmin-bssadmin.obj: bp/bss/bssadmin.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(bssadmin_CFLAGS) $(CFLAGS) -MT bp/bss/bssadmin-bssadmin.obj -MD -MP -MF bp/bss/$(DEPDIR)/bssadmin-bssadmin.Tpo -c -o bp/bss/bssadmin-bssadmin.obj `if test -f 'bp/bss/bssadmin.c'; then $(CYGPATH_W) 'bp/bss/bssadmin.c'; else $(CYGPATH_W) '$(srcdir)/bp/bss/bssadmin.c'; fi`
	$(AM_V_at)$(am__mv) bp/bss/$(DEPDIR)/bssadmin-bssadmin.Tpo bp/bss/$(DEPDIR)/bssadmin-bssadmin.Po
#	$(AM_V_CC)source='bp/bss/bssadmin.c' object='bp/bss/bssadmin-bssadmin.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(bssadmin_CFLAGS) $(CFLAGS) -c -o bp/bss/bssadmin-bssadmin.obj `if test -f 'bp/bss/bssadmin.c'; then $(CYGPATH_W) 'bp/bss/bssadmin.c'; else $(CYGPATH_W) '$(srcdir)/bp/bss/bssadmin.c'; fi`
...
bp/bss/bssfw-bssfw.o: bp/bss/bssfw.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(bssfw_CFLAGS) $(CFLAGS) -MT bp/bss/bssfw-bssfw.o -MD -MP -MF bp/bss/$(DEPDIR)/bssfw-bssfw.Tpo -c -o bp/bss/bssfw-bssfw.o `test -f 'bp/bss/bssfw.c' || echo '$(srcdir)/'`bp/bss/bssfw.c
	$(AM_V_at)$(am__mv) bp/bss/$(DEPDIR)/bssfw-bssfw.Tpo bp/bss/$(DEPDIR)/bssfw-bssfw.Po
#	$(AM_V_CC)source='bp/bss/bssfw.c' object='bp/bss/bssfw-bssfw.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(bssfw_CFLAGS) $(CFLAGS) -c -o bp/bss/bssfw-bssfw.o `test -f 'bp/bss/bssfw.c' || echo '$(srcdir)/'`bp/bss/bssfw.c

bp/bss/bssfw-bssfw.obj: bp/bss/bssfw.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(bssfw_CFLAGS) $(CFLAGS) -MT bp/bss/bssfw-bssfw.obj -MD -MP -MF bp/bss/$(DEPDIR)/bssfw-bssfw.Tpo -c -o bp/bss/bssfw-bssfw.obj `if test -f 'bp/bss/bssfw.c'; then $(CYGPATH_W) 'bp/bss/bssfw.c'; else $(CYGPATH_W) '$(srcdir)/bp/bss/bssfw.c'; fi`
	$(AM_V_at)$(am__mv) bp/bss/$(DEPDIR)/bssfw-bssfw.Tpo bp/bss/$(DEPDIR)/bssfw-bssfw.Po
#	$(AM_V_CC)source='bp/bss/bssfw.c' object='bp/bss/bssfw-bssfw.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(bssfw_CFLAGS) $(CFLAGS) -c -o bp/bss/bssfw-bssfw.obj `if test -f 'bp/bss/bssfw.c'; then $(CYGPATH_W) 'bp/bss/bssfw.c'; else $(CYGPATH_W) '$(srcdir)/bp/bss/bssfw.c'; fi`
...
tests/1400.loopback-stcp/tests_1400_loopback_stcp_dotest-dotest.o: tests/1400.loopback-stcp/dotest.c
	...
	$(AM_V_at)$(am__mv) tests/1400.loopback-stcp/$(DEPDIR)/tests_1400_loopback_stcp_dotest-dotest.Tpo tests/1400.loopback-stcp/$(DEPDIR)/tests_1400_loopback_stcp_dotest-dotest.Po
#	$(AM_V_CC)source='tests/1400.loopback-stcp/dotest.c' object='tests/1400.loopback-stcp/tests_1400_loopback_stcp_dotest-dotest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(tests_1400_loopback_stcp_dotest_CFLAGS) $(CFLAGS) -c -o tests/1400.loopback-stcp/tests_1400_loopback_stcp_dotest-dotest.o `test -f 'tests/1400.loopback-stcp/dotest.c' || echo '$(srcdir)/'`tests/1400.loopback-stcp/dotest.c
...
tests/1400.loopback-stcp/tests_1400_loopback_stcp_dotest-dotest.obj: tests/1400.loopback-stcp/dotest.c
	...
	$(AM_V_at)$(am__mv) tests/1400.loopback-stcp/$(DEPDIR)/tests_1400_loopback_stcp_dotest-dotest.Tpo tests/1400.loopback-stcp/$(DEPDIR)/tests_1400_loopback_stcp_dotest-dotest.Po
#	$(AM_V_CC)source='tests/1400.loopback-stcp/dotest.c' object='tests/1400.loopback-stcp/tests_1400_loopback_stcp_dotest-dotest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
clean-libtool:
	...
	-rm -rf bp/bss/.libs bp/bss/_libs
...
distclean-generic:
	...
	-rm -f bp/bss/$(DEPDIR)/$(am__dirstamp)
	-rm -f bp/bss/$(am__dirstamp)
...
distclean: distclean-am
	...
	-rm -rf ams/library/$(DEPDIR) ams/rams/$(DEPDIR) ams/test/$(DEPDIR) ams/utils/$(DEPDIR) bp/brs/$(DEPDIR) bp/bss/$(DEPDIR) bp/cgr/$(DEPDIR) bp/daemon/$(DEPDIR) bp/dccp/$(DEPDIR) bp/dgr/$(DEPDIR) bp/dtn2/$(DEPDIR) bp/imc/$(DEPDIR) bp/ipn/$(DEPDIR) bp/library/$(DEPDIR) bp/library/acs/$(DEPDIR) bp/library/crypto/NULL_SUITES/$(DEPDIR) bp/library/ext/bae/$(DEPDIR) bp/library/ext/bsp/$(DEPDIR) bp/library/ext/cteb/$(DEPDIR) bp/library/ext/ecos/$(DEPDIR) bp/library/ext/phn/$(DEPDIR) bp/ltp/$(DEPDIR) bp/tcp/$(DEPDIR) bp/test/$(DEPDIR) bp/udp/$(DEPDIR) bp/utils/$(DEPDIR) bss/library/$(DEPDIR) bss/test/$(DEPDIR) cfdp/bp/$(DEPDIR) cfdp/daemon/$(DEPDIR) cfdp/library/$(DEPDIR) cfdp/test/$(DEPDIR) cfdp/utils/$(DEPDIR) dgr/library/$(DEPDIR) dgr/test/$(DEPDIR) ici/daemon/$(DEPDIR) ici/library/$(DEPDIR) ici/sdr/$(DEPDIR) ici/test/$(DEPDIR) ici/utils/$(DEPDIR) ltp/aos/$(DEPDIR) ltp/daemon/$(DEPDIR) ltp/dccp/$(DEPDIR) ltp/library/$(DEPDIR) ltp/test/$(DEPDIR) ltp/udp/$(DEPDIR) ltp/utils/$(DEPDIR) restart/utils/$(DEPDIR) tests/1000.loopback/$(DEPDIR) tests/1300.loopback-tcp/$(DEPDIR) tests/1400.loopback-stcp/$(DEPDIR) tests/1500.loopback-brs/$(DEPDIR) tests/bug-0015-tcpclo-bpcp-sig-handling/$(DEPDIR) tests/issue-188-common-cos-syntax/$(DEPDIR) tests/issue-260-teach-valgrind-mtake/$(DEPDIR) tests/issue-279-bpMemo-timeline/$(DEPDIR) tests/issue-330-cfdpclock-FDU-removal/$(DEPDIR) tests/issue-333-cfdp-orig-ID-type/$(DEPDIR) tests/issue-334-cfdp-transaction-id/$(DEPDIR) tests/library/$(DEPDIR)
	-rm -f Makefile
