...
extern int	rgr_processOnFwd(ExtensionBlock *blk, Bundle *bundle, void *ctxt);

extern int	rgr_processOnAccept(ExtensionBlock *blk, Bundle *bundle, void *ctxt);

extern int	rgr_processOnEnqueue(ExtensionBlock *blk, Bundle *bundle, void *ctxt);

extern int	rgr_processOnDequeue(ExtensionBlock *, Bundle *, void *);
extern int	rgr_acquire(AcqExtBlock *, AcqWorkArea *);
extern int rgr_check(AcqExtBlock *blk, AcqWorkArea *wk);
