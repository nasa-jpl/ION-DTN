...
B<bpsource> I<destinationEndpointId> ['I<text>']
...
endpoint ID, i.e., the bundles are anonymous.  All bundles are sent with
TTL = 300 seconds (5 minutes), standard priority, no custody transfer,
