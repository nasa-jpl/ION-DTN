...
void adm_bpsec_init_atomic()
{
...
#ifdef AGENT_ROLE
	adm_add_datadef(ADM_BPSEC_AD_TOT_GOOD_TX_BCB_BLKS,  DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_good_tx_bcb_blks,  NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_TX_BCB_BLKS,  DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_fail_tx_bcb_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_GOOD_RX_BCB_BLKS,  DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_good_rx_bcb_blks,  NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_RX_BCB_BLKS,  DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_fail_rx_bcb_blks,  NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_MISSING_BCB_BLKS,  DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_missing_bcb_blks,  NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_FORWARD_BCB_BLKS,  DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_forward_bcb_blks,  NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_GOOD_TX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_good_tx_bcb_bytes,  NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_TX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_fail_tx_bcb_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_GOOD_RX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_good_rx_bcb_bytes,  NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_RX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_fail_rx_bcb_bytes,  NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_MISSING_BCB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_missing_bcb_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_FORWARD_BCB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_forward_bcb_bytes, NULL, NULL);

	adm_add_datadef(ADM_BPSEC_AD_TOT_GOOD_TX_BIB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_good_tx_bib_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_TX_BIB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_fail_tx_bib_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_GOOD_RX_BIB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_good_rx_bib_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_RX_BIB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_fail_rx_bib_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_MISSING_BIB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_missing_bib_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_FORWARD_BIB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_forward_bib_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_GOOD_TX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_good_tx_bib_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_TX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_fail_tx_bib_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_GOOD_RX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_good_rx_bib_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_RX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_fail_rx_bib_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_MISSING_BIB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_missing_bib_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_TOT_FORWARD_BIB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_tot_forward_bib_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_LAST_UPDATE, DTNMP_TYPE_UINT, 0, adm_bpsec_get_last_update, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_NUM_KEYS, DTNMP_TYPE_UINT, 0, adm_bpsec_get_num_keys, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_KEYS, DTNMP_TYPE_STRING, 0, adm_bpsec_get_keys, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_CIPHS, DTNMP_TYPE_STRING, 0, adm_bpsec_get_ciphs, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRCS, DTNMP_TYPE_STRING, 0, adm_bpsec_get_srcs, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_TX_BCB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_good_tx_bcb_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_TX_BCB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_fail_tx_bcb_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_RX_BCB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_good_rx_bcb_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_RX_BCB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_fail_rx_bcb_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_MISSING_BCB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_missing_bcb_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_FORWARD_BCB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_forward_bcb_blks, NULL, NULL);

	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_TX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_good_tx_bcb_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_TX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_fail_tx_bcb_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_RX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_good_rx_bcb_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_RX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_fail_rx_bcb_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_MISSING_BCB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_missing_bcb_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_FORWARD_BCB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_forward_bcb_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_TX_BIB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_good_tx_bib_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_TX_BIB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_fail_tx_bib_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_RX_BIB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_good_rx_bib_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_RX_BIB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_fail_rx_bib_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_MISSING_BIB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_missing_bib_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_FORWARD_BIB_BLKS, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_forward_bib_blks, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_TX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_good_tx_bib_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_TX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_fail_tx_bib_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_RX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_good_rx_bib_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_RX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_fail_rx_bib_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_MISSING_BIB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_missing_bib_bytes, NULL, NULL);
	adm_add_datadef(ADM_BPSEC_AD_SRC_FORWARD_BIB_BYTES, DTNMP_TYPE_UVAST, 0, adm_bpsec_get_src_forward_bib_bytes, NULL, NULL);

	adm_add_datadef(ADM_BPSEC_AD_SRC_LAST_UPDATE, DTNMP_TYPE_UINT, 0, adm_bpsec_get_src_last_update, NULL, NULL);

	adm_add_datadef(ADM_BPSEC_AD_LAST_RESET, DTNMP_TYPE_TS, 0, adm_bpsec_get_last_reset, NULL, NULL);

	#else

	adm_add_datadef(ADM_BPSEC_AD_TOT_GOOD_TX_BCB_BLKS,  DTNMP_TYPE_UVAST, 0, NULL,  NULL, NULL);
	names_add_name("ADM_BPSEC_AD_TOT_GOOD_TX_BCB_BLKS", "Total BCB Block Tx Success", ADM_BPSEC, ADM_BPSEC_AD_TOT_GOOD_TX_BCB_BLKS);

	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_TX_BCB_BLKS,  DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_TOT_FAIL_TX_BCB_BLKS", "Total BCB Block Tx Failures", ADM_BPSEC, ADM_BPSEC_AD_TOT_FAIL_TX_BCB_BLKS);

	adm_add_datadef(ADM_BPSEC_AD_TOT_GOOD_RX_BCB_BLKS,  DTNMP_TYPE_UVAST, 0, NULL,  NULL, NULL);
	names_add_name("ADM_BPSEC_AD_TOT_GOOD_RX_BCB_BLKS", "Total BCB Block Rx Success", ADM_BPSEC, ADM_BPSEC_AD_TOT_GOOD_RX_BCB_BLKS);

	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_RX_BCB_BLKS,  DTNMP_TYPE_UVAST, 0, NULL,  NULL, NULL);
	names_add_name("ADM_BPSEC_AD_TOT_FAIL_RX_BCB_BLKS", "Total BCB Block Rx Failure", ADM_BPSEC, ADM_BPSEC_AD_TOT_FAIL_RX_BCB_BLKS);

	adm_add_datadef(ADM_BPSEC_AD_TOT_MISSING_BCB_BLKS,  DTNMP_TYPE_UVAST, 0, NULL,  NULL, NULL);
	names_add_name("ADM_BPSEC_AD_TOT_MISSING_BCB_BLKS", "Total BCB Blocks Missing", ADM_BPSEC, ADM_BPSEC_AD_TOT_MISSING_BCB_BLKS);

	adm_add_datadef(ADM_BPSEC_AD_TOT_FORWARD_BCB_BLKS,  DTNMP_TYPE_UVAST, 0, NULL,  NULL, NULL);
	names_add_name("ADM_BPSEC_AD_TOT_FORWARD_BCB_BLKS", "Total BCB Blocks Forwarded", ADM_BPSEC, ADM_BPSEC_AD_TOT_FORWARD_BCB_BLKS);

	adm_add_datadef(ADM_BPSEC_AD_TOT_GOOD_TX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, NULL,  NULL, NULL);
	...
	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_TX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	...
	adm_add_datadef(ADM_BPSEC_AD_TOT_GOOD_RX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, NULL,  NULL, NULL);
	...
	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_RX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, NULL,  NULL, NULL);
	...
	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_TX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	...
	adm_add_datadef(ADM_BPSEC_AD_TOT_GOOD_RX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	...
	adm_add_datadef(ADM_BPSEC_AD_TOT_FAIL_RX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	...
	adm_add_datadef(ADM_BPSEC_AD_TOT_MISSING_BIB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_TOT_MISSING_BIB_BYTES", "Total BIB Bytes Missing", ADM_BPSEC, ADM_BPSEC_AD_TOT_MISSING_BIB_BYTES);

	adm_add_datadef(ADM_BPSEC_AD_TOT_FORWARD_BIB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_TOT_FORWARD_BIB_BYTES", "Total BIB Bytes Forwarded", ADM_BPSEC, ADM_BPSEC_AD_TOT_FORWARD_BIB_BYTES);

	adm_add_datadef(ADM_BPSEC_AD_LAST_UPDATE, DTNMP_TYPE_TS, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_LAST_UPDATE", "BPSEC Last Update", ADM_BPSEC, ADM_BPSEC_AD_LAST_UPDATE);

	adm_add_datadef(ADM_BPSEC_AD_NUM_KEYS, DTNMP_TYPE_UINT, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_NUM_KEYS", "BPSEC # Keys", ADM_BPSEC, ADM_BPSEC_AD_NUM_KEYS);

	adm_add_datadef(ADM_BPSEC_AD_KEYS, DTNMP_TYPE_STRING, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_KEYS", "Key Names", ADM_BPSEC, ADM_BPSEC_AD_KEYS);

	adm_add_datadef(ADM_BPSEC_AD_CIPHS, DTNMP_TYPE_STRING, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_CIPHS", "BPSEC Ciphersuites", ADM_BPSEC, ADM_BPSEC_AD_CIPHS);

	adm_add_datadef(ADM_BPSEC_AD_SRCS, DTNMP_TYPE_STRING, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRCS", "BPSEC Sources", ADM_BPSEC, ADM_BPSEC_AD_SRCS);



	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_TX_BCB_BLKS, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_GOOD_TX_BCB_BLKS", "Src BCB Block Tx Success", ADM_BPSEC, ADM_BPSEC_AD_SRC_GOOD_TX_BCB_BLKS);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_GOOD_TX_BCB_BLKS, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_TX_BCB_BLKS, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_FAIL_TX_BCB_BLKS", "Src BCB Block Tx Failures", ADM_BPSEC, ADM_BPSEC_AD_SRC_FAIL_TX_BCB_BLKS);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_FAIL_TX_BCB_BLKS, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_RX_BCB_BLKS, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_GOOD_RX_BCB_BLKS", "Src BCB Block Rx Success", ADM_BPSEC, ADM_BPSEC_AD_SRC_GOOD_RX_BCB_BLKS);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_GOOD_RX_BCB_BLKS, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_RX_BCB_BLKS, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_FAIL_RX_BCB_BLKS", "Src BCB Block Rx Failures", ADM_BPSEC, ADM_BPSEC_AD_SRC_FAIL_RX_BCB_BLKS);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_FAIL_RX_BCB_BLKS, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_MISSING_BCB_BLKS, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_MISSING_BCB_BLKS", "Src BCB Block Missing", ADM_BPSEC, ADM_BPSEC_AD_SRC_MISSING_BCB_BLKS);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_MISSING_BCB_BLKS, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_FORWARD_BCB_BLKS, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_FORWARD_BCB_BLKS", "Src BCB Block Forwarded", ADM_BPSEC, ADM_BPSEC_AD_SRC_FORWARD_BCB_BLKS);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_FORWARD_BCB_BLKS, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_TX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_GOOD_TX_BCB_BYTES", "Src BCB Bytes Tx Success", ADM_BPSEC, ADM_BPSEC_AD_SRC_GOOD_TX_BCB_BYTES);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_GOOD_TX_BCB_BYTES, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_TX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_FAIL_TX_BCB_BYTES", "Src BCB Bytes Tx Failure", ADM_BPSEC, ADM_BPSEC_AD_SRC_FAIL_TX_BCB_BYTES);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_FAIL_TX_BCB_BYTES, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_RX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_GOOD_RX_BCB_BYTES", "Src BCB Bytes Rx Success", ADM_BPSEC, ADM_BPSEC_AD_SRC_GOOD_RX_BCB_BYTES);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_GOOD_RX_BCB_BYTES, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_RX_BCB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_FAIL_RX_BCB_BYTES", "Src BCB Bytes Rx Failure", ADM_BPSEC, ADM_BPSEC_AD_SRC_FAIL_RX_BCB_BYTES);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_FAIL_RX_BCB_BYTES, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_MISSING_BCB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_MISSING_BCB_BYTES", "Src BCB Bytes Missing", ADM_BPSEC, ADM_BPSEC_AD_SRC_MISSING_BCB_BYTES);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_MISSING_BCB_BYTES, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_FORWARD_BCB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_FORWARD_BCB_BYTES", "Src BCB Bytes Forwarded", ADM_BPSEC, ADM_BPSEC_AD_SRC_FORWARD_BCB_BYTES);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_FORWARD_BCB_BYTES, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_TX_BIB_BLKS, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_GOOD_TX_BIB_BLKS", "Src BIB Block Tx Success", ADM_BPSEC, ADM_BPSEC_AD_SRC_GOOD_TX_BIB_BLKS);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_GOOD_TX_BIB_BLKS, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_TX_BIB_BLKS, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_FAIL_TX_BIB_BLKS", "Src BIB Block Tx Failure", ADM_BPSEC, ADM_BPSEC_AD_SRC_FAIL_TX_BIB_BLKS);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_FAIL_TX_BIB_BLKS, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_RX_BIB_BLKS, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_GOOD_RX_BIB_BLKS", "Src BIB Block Rx Success", ADM_BPSEC, ADM_BPSEC_AD_SRC_GOOD_RX_BIB_BLKS);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_GOOD_RX_BIB_BLKS, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_RX_BIB_BLKS, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_FAIL_RX_BIB_BLKS", "Src BIB Block Rx Failure", ADM_BPSEC, ADM_BPSEC_AD_SRC_FAIL_RX_BIB_BLKS);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_FAIL_RX_BIB_BLKS, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_MISSING_BIB_BLKS, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_MISSING_BIB_BLKS", "Src BIB Block Missing", ADM_BPSEC, ADM_BPSEC_AD_SRC_MISSING_BIB_BLKS);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_MISSING_BIB_BLKS, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_FORWARD_BIB_BLKS, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_FORWARD_BIB_BLKS", "Src BIB Block Forwarded", ADM_BPSEC, ADM_BPSEC_AD_SRC_FORWARD_BIB_BLKS);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_FORWARD_BIB_BLKS, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_TX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_GOOD_TX_BIB_BYTES", "Src BIB Bytes Tx Success", ADM_BPSEC, ADM_BPSEC_AD_SRC_GOOD_TX_BIB_BYTES);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_GOOD_TX_BIB_BYTES, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_TX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_FAIL_TX_BIB_BYTES", "Src BIB Bytes Tx Failure", ADM_BPSEC, ADM_BPSEC_AD_SRC_FAIL_TX_BIB_BYTES);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_FAIL_TX_BIB_BYTES, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_GOOD_RX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_GOOD_RX_BIB_BYTES", "Src BIB Bytes Rx Success", ADM_BPSEC, ADM_BPSEC_AD_SRC_GOOD_RX_BIB_BYTES);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_GOOD_RX_BIB_BYTES, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_FAIL_RX_BIB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_FAIL_RX_BIB_BYTES", "Src BIB Bytes Rx Failure", ADM_BPSEC, ADM_BPSEC_AD_SRC_FAIL_RX_BIB_BYTES);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_FAIL_RX_BIB_BYTES, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_MISSING_BIB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_MISSING_BIB_BYTES", "Src BIB Bytes Missing", ADM_BPSEC, ADM_BPSEC_AD_SRC_MISSING_BIB_BYTES);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_MISSING_BIB_BYTES, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_FORWARD_BIB_BYTES, DTNMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_FORWARD_BIB_BYTES", "Src BIB Bytes Forwarded", ADM_BPSEC, ADM_BPSEC_AD_SRC_FORWARD_BIB_BYTES);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_FORWARD_BIB_BYTES, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_SRC_LAST_UPDATE, DTNMP_TYPE_UINT, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_SRC_LAST_UPDATE", "Src Last Update", ADM_BPSEC, ADM_BPSEC_AD_SRC_LAST_UPDATE);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_SRC_LAST_UPDATE, "Src Name", DTNMP_TYPE_STRING);

	adm_add_datadef(ADM_BPSEC_AD_LAST_RESET, DTNMP_TYPE_TS, 0, NULL, NULL, NULL);
	names_add_name("ADM_BPSEC_AD_LAST_RESET", "Last Reset Time", ADM_BPSEC, ADM_BPSEC_AD_LAST_RESET);
	UI_ADD_PARMSPEC_1(ADM_BPSEC_AD_LAST_RESET, "Src Name", DTNMP_TYPE_STRING);
...
void adm_bpsec_init_controls()
{
	...
	UI_ADD_PARMSPEC_1(ADM_BPSEC_CTL_RESET_SRC_MID, "Source", DTNMP_TYPE_STRING);
	...
	UI_ADD_PARMSPEC_1(ADM_BPSEC_CTL_DEL_KEY_MID, "Key Name", DTNMP_TYPE_STRING);
	...
	UI_ADD_PARMSPEC_2(ADM_BPSEC_CTL_ADD_KEY_MID, "Key Name", DTNMP_TYPE_STRING, "Key Value", DTNMP_TYPE_BLOB);
	...
	UI_ADD_PARMSPEC_5(ADM_BPSEC_CTL_ADD_BIB_RULE_MID, "SRC", DTNMP_TYPE_STRING, \
			                                          "DEST", DTNMP_TYPE_STRING, \
													  "Target", DTNMP_TYPE_INT, \
												      "Ciphersuite", DTNMP_TYPE_STRING, "Key Name", DTNMP_TYPE_STRING);
	...
	UI_ADD_PARMSPEC_3(ADM_BPSEC_CTL_DEL_BIB_RULE_MID, "SRC", DTNMP_TYPE_STRING, \
			                                          "DEST", DTNMP_TYPE_STRING, \
													  "Target", DTNMP_TYPE_INT);
	...
	UI_ADD_PARMSPEC_5(ADM_BPSEC_CTL_ADD_BCB_RULE_MID, "SRC", DTNMP_TYPE_STRING, \
			                                          "DEST", DTNMP_TYPE_STRING, \
													  "Target", DTNMP_TYPE_INT, \
												      "Ciphersuite", DTNMP_TYPE_STRING, "Key Name", DTNMP_TYPE_STRING);
	...
	UI_ADD_PARMSPEC_3(ADM_BPSEC_CTL_DEL_BCB_RULE_MID, "SRC", DTNMP_TYPE_STRING, \
				                                          "DEST", DTNMP_TYPE_STRING, \
														  "Target", DTNMP_TYPE_INT);
	...
	UI_ADD_PARMSPEC_5(ADM_BPSEC_CTL_UP_BIB_RULE_MID, "SRC", DTNMP_TYPE_STRING, \
			                                          "DEST", DTNMP_TYPE_STRING, \
													  "Target", DTNMP_TYPE_INT, \
												      "Ciphersuite", DTNMP_TYPE_STRING, "Key Name", DTNMP_TYPE_STRING);
	...
	UI_ADD_PARMSPEC_5(ADM_BPSEC_CTL_UP_BCB_RULE_MID, "SRC", DTNMP_TYPE_STRING, \
			                                          "DEST", DTNMP_TYPE_STRING, \
													  "Target", DTNMP_TYPE_INT, \
												      "Ciphersuite", DTNMP_TYPE_STRING, "Key Name", DTNMP_TYPE_STRING);
...
#ifdef AGENT_ROLE
	adm_add_datadef(ADM_BPSEC_MD_NAME_MID, DTNMP_TYPE_STRING, 0, adm_bpsec_md_name, adm_print_string, adm_size_string);
	adm_add_datadef(ADM_BPSEC_MD_VER_MID,  DTNMP_TYPE_STRING, 0, adm_bpsec_md_ver,  adm_print_string, adm_size_string);
#else
	adm_add_datadef(ADM_BPSEC_MD_NAME_MID, DTNMP_TYPE_STRING, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("ADM_BPSEC_MD_NAME_MID", "ADM Name", ADM_BPSEC, ADM_BPSEC_MD_NAME_MID);

	adm_add_datadef(ADM_BPSEC_MD_VER_MID,  DTNMP_TYPE_STRING, 0, NULL, adm_print_string, adm_size_string);
...
void adm_bpsec_init_reports()
{
	...
	UI_ADD_PARMSPEC_1(ADM_BPSEC_RPT_SRC_MID, "Source Name", DTNMP_TYPE_STRING);
#endif
