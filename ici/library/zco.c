...
#if ZCODEBUG
char	buf[128];
isprintf(buf, sizeof buf, "[i] %s bulk occupancy increased to %f .",
...
#if ZCODEBUG
char	buf[128];
isprintf(buf, sizeof buf, "[i] %s bulk occupancy reduced to %f .",
bookNames[((int) acct)], book->bulkOccupancy);
writeMemo(buf);
#endif
	}
...
#if ZCODEBUG
char	buf[128];
isprintf(buf, sizeof buf, "[i] %s heap occupancy increased to %f .",
...
#if ZCODEBUG
char	buf[128];
isprintf(buf, sizeof buf, "[i] %s heap occupancy reduced to %f .",
bookNames[((int) acct)], book->heapOccupancy);
writeMemo(buf);
#endif
	}
