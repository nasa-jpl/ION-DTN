...
libltp_la_DEPENDENCIES = libici.la $(am__DEPENDENCIES_1)
...
am__EXEEXT_6 = bpadmin$(EXEEXT) bpsink$(EXEEXT) bpdriver$(EXEEXT) \
	...
	hmackeys$(EXEEXT) $(am__EXEEXT_4) $(am__EXEEXT_5)
am__EXEEXT_7 = bssrecv$(EXEEXT) bssStreamingApp$(EXEEXT) \
	bsscounter$(EXEEXT) bssdriver$(EXEEXT)
am__EXEEXT_8 = ionrestart$(EXEEXT)
am__EXEEXT_9 = nm_agent$(EXEEXT) nm_mgr$(EXEEXT)
am__EXEEXT_10 = amsd$(EXEEXT) amshello$(EXEEXT) \
	amsshell$(EXEEXT) amslog$(EXEEXT) \
	amslogprt$(EXEEXT) amsbenchs$(EXEEXT) \
	amsbenchr$(EXEEXT) amsstop$(EXEEXT) \
	ramsgate$(EXEEXT)
am__EXEEXT_11 = cfdpadmin$(EXEEXT) \
	cfdpclock$(EXEEXT) bputa$(EXEEXT) \
	cfdptest$(EXEEXT) bpcp$(EXEEXT) \
	bpcpd$(EXEEXT)
am__EXEEXT_12 = $(am__EXEEXT_10) $(am__EXEEXT_11)
am__EXEEXT_13 = tests/issue-330-cfdpclock-FDU-removal/cfdplisten$(EXEEXT) \
...
SOURCES = $(libams_la_SOURCES) $(libbp_la_SOURCES) \
	...
	$(cfdptest_SOURCES) $(dccpcli_SOURCES) $(dccpclo_SOURCES) \
...
am__include_HEADERS_DIST = ici/include/llcv.h ici/include/platform.h \
	...
	ici/library/icinm.h ltp/include/ltp.h dgr/include/dgr.h \
	bp/include/bp.h bss/include/bss.h ams/include/ams.h \
...
ACLOCAL = ${SHELL} /home/apluser/ion/ion-2013-08-02/ion-open-source/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /home/apluser/ion/ion-2013-08-02/ion-open-source/missing --run autoconf
AUTOHEADER = ${SHELL} /home/apluser/ion/ion-2013-08-02/ion-open-source/missing --run autoheader
AUTOMAKE = ${SHELL} /home/apluser/ion/ion-2013-08-02/ion-open-source/missing --run automake-1.11
AWK = mawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -DENABLE_IMC -DENABLE_BPACS -g -O2
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
...
ION_CFLAGS =  -Dlinux -DSPACE_ORDER=3 -fno-strict-aliasing
ION_LINK_FLAGS = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/apluser/ion/ion-2013-08-02/ion-open-source/missing --run makeinfo
MANIFEST_TOOL = :
MANOPTS = /usr/bin/man
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
...
PACKAGE_NAME = ion
PACKAGE_STRING = ion open source 3.1.3
PACKAGE_TARNAME = ion
PACKAGE_URL = 
PACKAGE_VERSION = open source 3.1.3
PATH_SEPARATOR = :
PDF2PS = /usr/bin/pdf2ps
POD_DOCUMENTATION = pod2man
PS2PDF = /usr/bin/ps2pdf
PSJOIN = /home/apluser/ion/ion-2013-08-02/ion-open-source/doc/psjoin
...
VERSION = open source 3.1.3
abs_builddir = /home/apluser/ion/ion-2013-08-02/ion-open-source
abs_srcdir = /home/apluser/ion/ion-2013-08-02/ion-open-source
abs_top_builddir = /home/apluser/ion/ion-2013-08-02/ion-open-source
abs_top_srcdir = /home/apluser/ion/ion-2013-08-02/ion-open-source
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/apluser/ion/ion-2013-08-02/ion-open-source/install-sh
...
bpbin = bpadmin bpsink bpdriver bpsource bpecho bpcancel bpcounter \
	...
	bpstats2 bpchat hmackeys $(am__append_8) $(am__append_9)
bplib = \
	libbp.la \
	libcgr.la \
	libipnfw.la \
...
#nm_mgr_LDFLAGS = -lmysqlclient
#nm_mgr_CFLAGS = -I$(srcdir)/ici/library -I$(srcdir)/bp/library -I$(srcdir)/ltp/library -I$(srcdir)/nm  -I$(srcdir)/nm/mgr -I/usr/include/mysql $(AM_CFLAGS) -Wno-unused-variable -DHAVE_MYSQL
