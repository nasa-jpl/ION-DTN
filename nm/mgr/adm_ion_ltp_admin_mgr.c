...
void adm_ion_ltp_admin_init_controls()
{
 ...
 ]    export session canceled by remote receiver", ADM_ION_LTP_ADMIN, ADM_ION_LTP_ADMIN_CTRL_WATCHSET_MID);
	UI_ADD_PARMSPEC_1(ADM_ION_LTP_ADMIN_CTRL_WATCHSET_MID, "status&UINT:activity", AMP_TYPE_UINT);
