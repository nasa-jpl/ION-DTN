...
of bundles destined for the "ipn"-scheme endpoint whose node identifier is the
identifier of the local node and whose service number is the DTPC_RECV_SVC_NBR
