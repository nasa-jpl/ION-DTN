...
import gov.nasa.jpl.iondtn.gui.AddEditDialogFragments.BibRuleDialogFragment;
import gov.nasa.jpl.iondtn.types.DtnBibRule;

/**
 * This Recycler adapter generates views for
 * {@link gov.nasa.jpl.iondtn.gui.MainFragments.BibRuleFragment}.
 *
 * @author Robert Wiewel
 */
public class BibRuleRecyclerViewAdapter extends RecyclerView
        .Adapter<BibRuleRecyclerViewAdapter.CustomViewHolder>{
    private ArrayList<DtnBibRule> dataset;
    private static final String TAG = "BibRuleAdapter";
     ...
     */
    public BibRuleRecyclerViewAdapter(String input, FragmentManager fr) {
        Log.d(TAG, "BibRuleRecyclerViewAdapter: got text: " + input);
    ...
    private void parseContent(String input) {
        ...
        while(linescanner.hasNextLine()) {
            ...
            DtnBibRule s = new DtnBibRule(tokens[0],
                    tokens[1],
                    tokens[2],
                    tokens[3],
                    tokens[4]);
            dataset.add(s);
            Log.d(TAG, "new DtnBibRule object: " + s.toString());
        }
    }
     ...
     */
    @Override
    public BibRuleRecyclerViewAdapter.CustomViewHolder onCreateViewHolder(final
                                                                          ViewGroup parent,
                                                                          int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recycler_bibrule_view_item_layout, parent,
                        false);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                android.support.v4.app.DialogFragment newFragment =
                        BibRuleDialogFragment.newInstance(dataset
                                .get(pos));
                newFragment.show(fragmentMgr, "Pibdf");
            }
        });
