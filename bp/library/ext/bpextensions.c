...
#ifndef BP_EXTENSIONS
#define BP_EXTENSIONS

/*	... and here.							*/

/* NK extensions[] is also used in the mnemonic lookup in ionsecadmin - i.e., the mapping from
 * the extension block name to its type. For example, "ecos -> EXTENSION_TYPE_ECOS"
 */
/*
...
ExtensionDef extensions[] =
{
		{ "bab", BSP_BAB_TYPE, 0,  // NK changed the name from bsp_bab_pre
				bsp_babOffer,
				bsp_babRelease,
				bsp_babAcquire,
				bsp_babPreCheck,
