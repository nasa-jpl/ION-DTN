...
void adm_ionsec_admin_init_controls()
{
	...
	adm_add_ctrl(mid_from_value(ADM_IONSEC_ADMIN_CTRL_LTP_RX_RULE_ADD_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_IONSEC_ADMIN_CTRL_LTP_RX_RULE_CHANGE_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_IONSEC_ADMIN_CTRL_LTP_RX_RULE_DEL_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_IONSEC_ADMIN_CTRL_LTP_TX_RULE_ADD_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_IONSEC_ADMIN_CTRL_LTP_TX_RULE_CHANGE_MID), NULL);
...
void adm_ionsec_admin_init_metadata()
{
	...
	adm_add_edd(mid_from_value(ADM_IONSEC_ADMIN_META_NAME_MID), AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("NAME", "The human-readable name of the ADM.", ADM_IONSEC_ADMIN, ADM_IONSEC_ADMIN_META_NAME_MID);
	adm_add_edd(mid_from_value(ADM_IONSEC_ADMIN_META_NAMESPACE_MID), AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("NAMESPACE", "The namespace of the ADM.", ADM_IONSEC_ADMIN, ADM_IONSEC_ADMIN_META_NAMESPACE_MID);
	adm_add_edd(mid_from_value(ADM_IONSEC_ADMIN_META_VERSION_MID), AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("VERSION", "The version of the ADM.", ADM_IONSEC_ADMIN, ADM_IONSEC_ADMIN_META_VERSION_MID);
	adm_add_edd(mid_from_value(ADM_IONSEC_ADMIN_META_ORGANIZATION_MID), AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
