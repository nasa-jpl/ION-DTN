...
void adm_bp_init_atomic()
{
	...
	adm_add_datadef(ADM_BP_AD_NODE_ID_MID,     0, bp_node_get_node_id,  adm_print_string, adm_size_string);
	adm_add_datadef(ADM_BP_AD_NODE_VER_MID,    0, bp_node_get_version,  adm_print_string, adm_size_string);
	adm_add_datadef(ADM_BP_AD_AVAIL_STOR_MID,  0, bp_node_get_storage,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RESET_TIME_MID,  0, bp_node_get_last_restart,  NULL, bp_size_node_restart_time);
	adm_add_datadef(ADM_BP_AD_NUM_REG_MID,     0, bp_node_get_num_reg,  NULL, bp_size_node_num_reg);
	adm_add_datadef(ADM_BP_AD_ENDPT_NAMES_MID, 0, bp_endpoint_get_names,  adm_print_string_list,   adm_size_string_list);

	adm_add_datadef(ADM_BP_AD_BNDL_CUR_FWD_PEND_CNT_MID,      0, bp_node_get_fwd_pend,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_CUR_DISPATCH_PEND_CNT_MID, 0, bp_node_get_dispatch_pend,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_CUR_IN_CUSTODY_CNT_MID,    0, bp_node_get_in_cust,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_CUR_REASSMBL_PEND_CNT_MID, 0, bp_node_get_reassembly_pend,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_CUR_BULK_RES_CNT_MID,      0, bp_node_get_blk_src_cnt,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_CUR_NORM_RES_CNT_MID,      0, bp_node_get_norm_src_cnt,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_CUR_EXP_RES_CNT_MID,       0, bp_node_get_exp_src_cnt,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_CUR_BULK_RES_BYTES_MID,    0, bp_node_get_blk_src_bytes,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_CUR_NORM_BYTES_MID,        0, bp_node_get_norm_src_bytes,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_CUR_EXP_BYTES_MID,         0, bp_node_get_exp_src_bytes,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_BULK_SRC_CNT_MID,          0, bp_node_get_blk_res_cnt,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_NORM_SRC_CNT_MID,          0, bp_node_get_norm_res_cnt,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_EXP_SRC_CNT_MID,           0, bp_node_get_exp_res_cnt,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_BULK_SRC_BYTES_MID,        0, bp_node_get_blk_res_bytes,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_NORM_SRC_BYTES_MID,        0, bp_node_get_norm_res_bytes,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_EXP_SRC_BYTES_MID,         0, bp_node_get_exp_res_bytes,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_FRAGMENTED_CNT_MID,        0, bp_node_get_bundles_frag,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_BNDL_FRAG_PRODUCED_MID,         0, bp_node_get_frag_produced,  NULL, NULL);

	adm_add_datadef(ADM_BP_AD_RPT_NOINFO_DEL_CNT_MID,  0, bp_node_get_del_none,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_EXPIRED_DEL_CNT_MID, 0, bp_node_get_del_expired,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_UNI_FWD_DEL_CNT_MID, 0, bp_node_get_del_fwd_uni,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_CANCEL_DEL_CNT_MID,  0, bp_node_get_del_cancel,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_NO_STRG_DEL_CNT_MID, 0, bp_node_get_del_deplete,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_BAD_EID_DEL_CNT_MID, 0, bp_node_get_del_bad_eid,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_NO_ROUTE_DEL_CNT_MID,     0, bp_node_get_del_no_route,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_NO_CONTACT_DEL_CNT_MID,   0, bp_node_get_del_no_contact,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_BAD_BLOCK_DEL_CNT_MID,    0, bp_node_get_del_bad_blk,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_BUNDLES_DEL_CNT_MID,      0, bp_node_get_del_bytes,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_FAIL_CUST_XFER_CNT_MID,   0, bp_node_get_fail_cust_cnt,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_FAIL_CUST_XFER_BYTES_MID, 0, bp_node_get_fail_cust_bytes,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_FAIL_FWD_CNT_MID,    0, bp_node_get_fail_fwd_cnt,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_FAIL_FWD_BYTES_MID,  0, bp_node_get_fail_fwd_bytes,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_ABANDONED_CNT_MID,   0, bp_node_get_fail_abandon_cnt,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_ABANDONED_BYTES_MID, 0, bp_node_get_fail_abandon_bytes,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_DISCARD_CNT_MID,     0, bp_node_get_fail_discard_cnt,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_RPT_DISCARD_BYTES_MID,   0, bp_node_get_fail_discard_bytes,  NULL, NULL);

	adm_add_datadef(ADM_BP_AD_ENDPT_NAME_MID,                1, bp_endpoint_get_name,  adm_print_string, bp_size_endpoint_name);
	adm_add_datadef(ADM_BP_AD_ENDPT_ACTIVE_MID,              1, bp_endpoint_get_active,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_ENDPT_SINGLETON_MID,           1, bp_endpoint_get_singleton,  NULL, NULL);
	adm_add_datadef(ADM_BP_AD_ENDPT_ABANDON_ON_DEL_FAIL_MID, 1, bp_endpoint_get_abandon,  NULL, NULL);

#else
	adm_add_datadef(ADM_BP_AD_NODE_ID_MID,     0, NULL,  adm_print_string, adm_size_string);
	names_add_name("NODE ID", "Node Identifier", ADM_BP, ADM_BP_AD_NODE_ID_MID);

	adm_add_datadef(ADM_BP_AD_NODE_VER_MID,    0, NULL,  adm_print_string, adm_size_string);
	names_add_name("NODE VER", "Node Version", ADM_BP, ADM_BP_AD_NODE_VER_MID);

	adm_add_datadef(ADM_BP_AD_AVAIL_STOR_MID,  0, NULL,  NULL, NULL);
	names_add_name("AVAIL STOR", "Available Storage in Bytes", ADM_BP, ADM_BP_AD_AVAIL_STOR_MID);

	adm_add_datadef(ADM_BP_AD_RESET_TIME_MID,  0, NULL,  NULL, bp_size_node_restart_time);
	names_add_name("RESET TIME", "UTC of Last Reset", ADM_BP, ADM_BP_AD_RESET_TIME_MID);

	adm_add_datadef(ADM_BP_AD_NUM_REG_MID,     0, NULL,  NULL, bp_size_node_num_reg);
	names_add_name("NUM REG", "# Registered Nodes", ADM_BP, ADM_BP_AD_NUM_REG_MID);

	adm_add_datadef(ADM_BP_AD_ENDPT_NAMES_MID, 0, NULL,  adm_print_string_list,   adm_size_string_list);
	names_add_name("ENDPT NAMES", "Endpoint Names", ADM_BP, ADM_BP_AD_ENDPT_NAMES_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_CUR_FWD_PEND_CNT_MID,      0, NULL,  NULL, NULL);
	names_add_name("CUR FWD PEND CNT", "# Bundles Pending Forwarding", ADM_BP, ADM_BP_AD_BNDL_CUR_FWD_PEND_CNT_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_CUR_DISPATCH_PEND_CNT_MID, 0, NULL,  NULL, NULL);
	names_add_name("CUR DISPATCH PEND CNT", "# Bundles Pending Dispatch", ADM_BP, ADM_BP_AD_BNDL_CUR_DISPATCH_PEND_CNT_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_CUR_IN_CUSTODY_CNT_MID,    0, NULL,  NULL, NULL);
	names_add_name("CUR IN CUSTODY CNT", "# Bundles In Custody", ADM_BP, ADM_BP_AD_BNDL_CUR_IN_CUSTODY_CNT_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_CUR_REASSMBL_PEND_CNT_MID, 0, NULL,  NULL, NULL);
	names_add_name("CUR REASSMBL PEND CNT", "# Bundles Pending Reassembly", ADM_BP, ADM_BP_AD_BNDL_CUR_REASSMBL_PEND_CNT_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_CUR_BULK_RES_CNT_MID,      0, NULL,  NULL, NULL);
	names_add_name("CUR BULK RES CNT", "# Bundles Pending Reassembly", ADM_BP, ADM_BP_AD_BNDL_CUR_BULK_RES_CNT_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_CUR_NORM_RES_CNT_MID,      0, NULL,  NULL, NULL);
	names_add_name("ADM_BP_AD_BNDL_CUR_NORM_RES_CNT_MID", "Cur Norm Res Cnt", ADM_BP, ADM_BP_AD_BNDL_CUR_NORM_RES_CNT_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_CUR_EXP_RES_CNT_MID,       0, NULL,  NULL, NULL);
	names_add_name("ADM_BP_AD_BNDL_CUR_EXP_RES_CNT_MID", "Cur Exp Res Cnt", ADM_BP, ADM_BP_AD_BNDL_CUR_EXP_RES_CNT_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_CUR_BULK_RES_BYTES_MID,    0, NULL,  NULL, NULL);
	names_add_name("ADM_BP_AD_BNDL_CUR_BULK_RES_BYTES_MID", "Cur Bulk Res Bytes", ADM_BP, ADM_BP_AD_BNDL_CUR_BULK_RES_BYTES_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_CUR_NORM_BYTES_MID,        0, NULL,  NULL, NULL);
	names_add_name("ADM_BP_AD_BNDL_CUR_NORM_BYTES_MID", "Cur Norm Bytes", ADM_BP, ADM_BP_AD_BNDL_CUR_NORM_BYTES_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_CUR_EXP_BYTES_MID,         0, NULL,  NULL, NULL);
	names_add_name("ADM_BP_AD_BNDL_CUR_EXP_BYTES_MID", "Cur Exp Bytes", ADM_BP, ADM_BP_AD_BNDL_CUR_EXP_BYTES_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_BULK_SRC_CNT_MID,          0, NULL,  NULL, NULL);
	names_add_name("ADM_BP_AD_BNDL_BULK_SRC_CNT_MID", "Bulk Src Cnt", ADM_BP, ADM_BP_AD_BNDL_BULK_SRC_CNT_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_NORM_SRC_CNT_MID,          0, NULL,  NULL, NULL);
	names_add_name("ADM_BP_AD_BNDL_NORM_SRC_CNT_MID", "Norm Src Cnt", ADM_BP, ADM_BP_AD_BNDL_NORM_SRC_CNT_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_EXP_SRC_CNT_MID,           0, NULL,  NULL, NULL);
	names_add_name("ADM_BP_AD_BNDL_EXP_SRC_CNT_MID", "Exp Src Cnt", ADM_BP, ADM_BP_AD_BNDL_EXP_SRC_CNT_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_BULK_SRC_BYTES_MID,        0, NULL,  NULL, NULL);
	names_add_name("ADM_BP_AD_BNDL_BULK_SRC_BYTES_MID", "Bulk Src Bytes", ADM_BP, ADM_BP_AD_BNDL_BULK_SRC_BYTES_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_NORM_SRC_BYTES_MID,        0, NULL,  NULL, NULL);
	names_add_name("ADM_BP_AD_BNDL_NORM_SRC_BYTES_MID", "Norm Src Bytes", ADM_BP, ADM_BP_AD_BNDL_NORM_SRC_BYTES_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_EXP_SRC_BYTES_MID,         0, NULL,  NULL, NULL);
	names_add_name("ADM_BP_AD_BNDL_EXP_SRC_BYTES_MID", "Exp Src Bytes", ADM_BP, ADM_BP_AD_BNDL_EXP_SRC_BYTES_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_FRAGMENTED_CNT_MID,        0, NULL,  NULL, NULL);
	names_add_name("ADM_BP_AD_BNDL_FRAGMENTED_CNT_MID", "Bundles Fragmented Count", ADM_BP, ADM_BP_AD_BNDL_FRAGMENTED_CNT_MID);

	adm_add_datadef(ADM_BP_AD_BNDL_FRAG_PRODUCED_MID,         0, NULL,  NULL, NULL);
...
#ifdef AGENT_ROLE
	adm_add_datadef(ADM_BP_MD_NAME_MID, 0, bp_md_name, adm_print_string, adm_size_string);
	adm_add_datadef(ADM_BP_MD_VER_MID,  0, bp_md_ver,  adm_print_string, adm_size_string);
#else
	adm_add_datadef(ADM_BP_MD_NAME_MID, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("ADM_BP_MD_NAME_MID", "BP Name", ADM_BP, ADM_BP_MD_NAME_MID);

	adm_add_datadef(ADM_BP_MD_VER_MID,  0, NULL, adm_print_string, adm_size_string);
