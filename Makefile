...
am_nm_agent_OBJECTS = nm/agent/nm_agent-ingest.$(OBJEXT) \
	...
	nm/shared/adm/nm_agent-adm_agent_impl.$(OBJEXT) \
	nm/shared/adm/nm_agent-adm_bp_impl.$(OBJEXT) \
	...
	nm/shared/primitives/nm_agent-instr.$(OBJEXT) \
...
am_nm_mgr_OBJECTS = nm/mgr/nm_mgr-nm_mgr.$(OBJEXT) \
	...
	nm/shared/adm/nm_mgr-adm_bp_impl.$(OBJEXT) \
	...
	nm/shared/primitives/nm_mgr-instr.$(OBJEXT) \
...
SOURCES = $(libams_la_SOURCES) $(libbp_la_SOURCES) \
	...
	$(aoslsi_SOURCES) $(aoslso_SOURCES) $(bibeclo_SOURCES) \
	...
	$(dgrcla_SOURCES) $(dtn2admin_SOURCES) $(dtn2adminep_SOURCES) \
	...
	$(nm_mgr_SOURCES) $(owltsim_SOURCES) $(owlttb_SOURCES) \
...
DIST_SOURCES = $(am__libams_la_SOURCES_DIST) \
	...
	$(aoslsi_SOURCES) $(aoslso_SOURCES) $(bibeclo_SOURCES) \
	$(bpadmin_SOURCES) $(bpcancel_SOURCES) $(bpchat_SOURCES) \
	$(bpclock_SOURCES) $(bpcounter_SOURCES) \
	...
	$(ltpclock_SOURCES) $(ltpcounter_SOURCES) $(ltpdriver_SOURCES) \
	$(ltpmeter_SOURCES) $(nm_agent_SOURCES) $(nm_mgr_SOURCES) \
	$(owltsim_SOURCES) $(owlttb_SOURCES) $(psmshell_SOURCES) \
	$(psmwatch_SOURCES) $(am__ramsgate_SOURCES_DIST) \
	$(rfxclock_SOURCES) $(sdatest_SOURCES) $(sdr2file_SOURCES) \
	$(sdrmend_SOURCES) $(sdrwatch_SOURCES) $(sm2file_SOURCES) \
	$(smlistsh_SOURCES) $(smrbtsh_SOURCES) $(stcpcli_SOURCES) \
	$(stcpclo_SOURCES) $(tcp2file_SOURCES) $(tcpbsi_SOURCES) \
...
am__include_HEADERS_DIST = ici/include/llcv.h ici/include/platform.h \
	...
	dgr/include/dgr.h bp/include/bp.h bss/include/bss.h \
	dtpc/include/dtpc.h bssp/include/bssp.h ams/include/ams.h \
	cfdp/include/cfdp.h cfdp/include/cfdpops.h
am__noinst_HEADERS_DIST = ici/library/lystP.h ici/sdr/sdrP.h \
	...
	bp/ipn/ipnfw.h bp/dtn2/dtn2fw.h bp/brs/brscla.h \
	bp/udp/udpcla.h bp/ltp/ltpcla.h bp/tcp/tcpcla.h \
	bp/dccp/dccpcla.h bss/library/bssP.h dtpc/library/dtpcP.h \
	bssp/library/bsspP.h ams/library/amscommon.h \
	ams/library/amsP.h ams/rams/rams.h ams/library/marshal.c \
	ams/library/default.marshal.c ams/library/default.crypt.c \
	ams/rams/ramscommon.h cfdp/library/cfdpP.h cfdp/utils/bpcp.h
...
ACLOCAL = ${SHELL} /home/ebirrane/ios/ion-open-source/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AM_CFLAGS =  -Dlinux -DSPACE_ORDER=3 -fno-strict-aliasing -DENABLE_BPACS -DENABLE_IMC -DENABLE_MANPAGES -Wall -Werror -g -include config.h \
	...
	-I$(srcdir)/bssp/include $(am__append_1) \
	$(VALGRIND_COMPAT_CFLAGS)
AM_DEFAULT_VERBOSITY = 1
AM_LDFLAGS =  -lpthread
AM_LIBTOOLFLAGS = 
AR = ar
AUTOCONF = ${SHELL} /home/ebirrane/ios/ion-open-source/missing autoconf
AUTOHEADER = ${SHELL} /home/ebirrane/ios/ion-open-source/missing autoheader
AUTOMAKE = ${SHELL} /home/ebirrane/ios/ion-open-source/missing automake-1.14
AWK = mawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/ebirrane/ios/ion-open-source/missing makeinfo
MANIFEST_TOOL = :
MANOPTS = /usr/bin/man
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
...
PACKAGE_NAME = ion
PACKAGE_STRING = ion open source 3.3.0
PACKAGE_TARNAME = ion
PACKAGE_URL = 
PACKAGE_VERSION = open source 3.3.0
PATH_SEPARATOR = :
PDF2PS = /usr/bin/pdf2ps
PDFJOIN = 
POD_DOCUMENTATION = pod2man
PS2PDF = /usr/bin/ps2pdf
PSJOIN = /home/ebirrane/ios/ion-open-source/doc/psjoin
RANLIB = ranlib
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/bash
STRIP = strip
VALGRIND_COMPAT_CFLAGS = 
VERSION = open source 3.3.0
abs_builddir = /home/ebirrane/ios/ion-open-source
abs_srcdir = /home/ebirrane/ios/ion-open-source
abs_top_builddir = /home/ebirrane/ios/ion-open-source
abs_top_srcdir = /home/ebirrane/ios/ion-open-source
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/ebirrane/ios/ion-open-source/install-sh
...
bpcflags = -I$(srcdir)/bp/library -I$(srcdir)/bp/library/acs -I$(srcdir)/bp/library/ext -I$(srcdir)/bp/library/ext/meb -I$(srcdir)/bp/library/ext/bae -I$(srcdir)/bp/library/ext/cteb -I$(srcdir)/bp/include -I$(srcdir)/bp/ipn -I$(srcdir)/bp/dtn2 -I$(srcdir)/bp/library/crypto -I$(srcdir)/bp/library/ext/ecos -I$(srcdir)/bp/library/ext/bsp -I$(srcdir)/bp/library/ext/bsp/ciphersuites -I$(srcdir)/bp/library/ext/phn -I$(srcdir)/bp/imc -I$(srcdir)/ici/include/ -I$(srcdir)/bp/library/ext/ecos -I$(srcdir)/bp/library/ext/bsp -I$(srcdir)/bp/imc -DBP_EXTENDED
bpbin = bpadmin bpsink bpdriver bpsource bpecho bpcancel bpcounter \
	...
	bsspcli bsspclo ipnadminep dtn2admin dtn2fw dtn2adminep tcpcli \
	tcpclo stcpcli stcpclo brsscla brsccla udpcli udpclo bibeclo \
	dccpcli dccpclo dgrcla ltpcli ltpclo lgsend lgagent bptrace \
	bping bpnmtest bpstats bpstats2 bpchat hmackeys cgrfetch \
...
libbp_la_SOURCES = bp/library/libbp.c bp/library/libbpP.c \
	...
	bp/library/ext/bsp/ciphersuites/bib_hmac_sha256.h \
	bp/library/ext/bsp/ciphersuites/bib_hmac_sha256.c \
	bp/library/ext/snid/snid.c $(am__append_12) $(am__append_13) \
	$(am__append_14) $(am__append_15)
libbp_la_CFLAGS = $(bpcflags) $(AM_CFLAGS)
libbp_la_LIBADD = libici.la $(CRYPTO_LIBS)
...
bsspcli_LDADD = libbssp.la libipnfw.la libdtn2fw.la libbp.la libici.la $(LIBOBJS) $(PTHREAD_LIBS)
...
ltpcli_LDADD = libipnfw.la libdtn2fw.la libbp.la libltp.la libici.la $(LIBOBJS) $(PTHREAD_LIBS)
...
tcpcli_LDADD = libipnfw.la libdtn2fw.la libbp.la libtcpcla.la libici.la $(LIBOBJS) $(PTHREAD_LIBS)
...
stcpcli_LDADD = libipnfw.la libdtn2fw.la libbp.la libtcpcla.la libici.la $(LIBOBJS) $(PTHREAD_LIBS)
...
udpcli_LDADD = libipnfw.la libdtn2fw.la libbp.la libudpcla.la libici.la $(LIBOBJS) $(PTHREAD_LIBS)
...
dccpcli_LDADD = libipnfw.la libdtn2fw.la libbp.la libici.la $(LIBOBJS) $(PTHREAD_LIBS)
...
dgrcla_LDADD = libipnfw.la libdtn2fw.la libbp.la libdgr.la libici.la $(LIBOBJS) $(PTHREAD_LIBS)
dgrcla_CFLAGS = $(bpcflags) $(AM_CFLAGS)

# --- BRS executables --- #
brsscla_SOURCES = bp/brs/brsscla.c
brsscla_LDADD = libipnfw.la libdtn2fw.la libbp.la libtcpcla.la libici.la $(LIBOBJS) $(PTHREAD_LIBS)
brsscla_CFLAGS = $(bpcflags) $(AM_CFLAGS)
brsccla_SOURCES = bp/brs/brsccla.c
brsccla_LDADD = libipnfw.la libdtn2fw.la libbp.la libtcpcla.la libici.la $(LIBOBJS) $(PTHREAD_LIBS)
...
nm_agent_SOURCES = nm/agent/ingest.c            nm/agent/lcc.c                 nm/agent/ldc.c \
                    nm/agent/nmagent.c           nm/agent/rda.c                 nm/agent/expr.c \
					...
					nm/shared/adm/adm_ltp.c 	 nm/shared/adm/adm_agent_impl.c nm/shared/adm/adm_bp_impl.c \
					...
					nm/shared/primitives/nn.c 	 nm/shared/primitives/instr.c   nm/shared/primitives/tdc.c\
...
nm_mgr_SOURCES = nm/mgr/nm_mgr.c              nm/mgr/nm_mgr_rx.c             nm/mgr/nm_mgr_ui.c \
					...
					nm/shared/adm/adm.c          nm/shared/adm/adm_bp.c         nm/shared/adm/adm_bp_impl.c \
...
nm/agent/nm_agent-rda.$(OBJEXT): nm/agent/$(am__dirstamp) \
	nm/agent/$(DEPDIR)/$(am__dirstamp)
nm/agent/nm_agent-expr.$(OBJEXT): nm/agent/$(am__dirstamp) \
	nm/agent/$(DEPDIR)/$(am__dirstamp)
...
include ici/crypto/NULL_SUITES/$(DEPDIR)/libbp_la-crypto.Plo
...
include nm/agent/$(DEPDIR)/nm_agent-expr.Po
...
include nm/shared/adm/$(DEPDIR)/nm_agent-adm_agent_impl.Po
include nm/shared/adm/$(DEPDIR)/nm_agent-adm_bp.Po
include nm/shared/adm/$(DEPDIR)/nm_agent-adm_bp_impl.Po
...
include nm/shared/adm/$(DEPDIR)/nm_mgr-adm_bp_impl.Po
...
include nm/shared/primitives/$(DEPDIR)/nm_agent-instr.Po
...
include nm/shared/primitives/$(DEPDIR)/nm_mgr-instr.Po
...
ici/crypto/NULL_SUITES/libbp_la-crypto.lo: ici/crypto/NULL_SUITES/crypto.c
	...
	$(AM_V_at)$(am__mv) ici/crypto/NULL_SUITES/$(DEPDIR)/libbp_la-crypto.Tpo ici/crypto/NULL_SUITES/$(DEPDIR)/libbp_la-crypto.Plo
#	$(AM_V_CC)source='ici/crypto/NULL_SUITES/crypto.c' object='ici/crypto/NULL_SUITES/libbp_la-crypto.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o ici/crypto/NULL_SUITES/libbp_la-crypto.lo `test -f 'ici/crypto/NULL_SUITES/crypto.c' || echo '$(srcdir)/'`ici/crypto/NULL_SUITES/crypto.c
...
nm/agent/nm_agent-expr.o: nm/agent/expr.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -MT nm/agent/nm_agent-expr.o -MD -MP -MF nm/agent/$(DEPDIR)/nm_agent-expr.Tpo -c -o nm/agent/nm_agent-expr.o `test -f 'nm/agent/expr.c' || echo '$(srcdir)/'`nm/agent/expr.c
	$(AM_V_at)$(am__mv) nm/agent/$(DEPDIR)/nm_agent-expr.Tpo nm/agent/$(DEPDIR)/nm_agent-expr.Po
#	$(AM_V_CC)source='nm/agent/expr.c' object='nm/agent/nm_agent-expr.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -c -o nm/agent/nm_agent-expr.o `test -f 'nm/agent/expr.c' || echo '$(srcdir)/'`nm/agent/expr.c

nm/agent/nm_agent-expr.obj: nm/agent/expr.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -MT nm/agent/nm_agent-expr.obj -MD -MP -MF nm/agent/$(DEPDIR)/nm_agent-expr.Tpo -c -o nm/agent/nm_agent-expr.obj `if test -f 'nm/agent/expr.c'; then $(CYGPATH_W) 'nm/agent/expr.c'; else $(CYGPATH_W) '$(srcdir)/nm/agent/expr.c'; fi`
	$(AM_V_at)$(am__mv) nm/agent/$(DEPDIR)/nm_agent-expr.Tpo nm/agent/$(DEPDIR)/nm_agent-expr.Po
#	$(AM_V_CC)source='nm/agent/expr.c' object='nm/agent/nm_agent-expr.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -c -o nm/agent/nm_agent-expr.obj `if test -f 'nm/agent/expr.c'; then $(CYGPATH_W) 'nm/agent/expr.c'; else $(CYGPATH_W) '$(srcdir)/nm/agent/expr.c'; fi`
...
nm/shared/adm/nm_agent-adm_agent_impl.o: nm/shared/adm/adm_agent_impl.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -MT nm/shared/adm/nm_agent-adm_agent_impl.o -MD -MP -MF nm/shared/adm/$(DEPDIR)/nm_agent-adm_agent_impl.Tpo -c -o nm/shared/adm/nm_agent-adm_agent_impl.o `test -f 'nm/shared/adm/adm_agent_impl.c' || echo '$(srcdir)/'`nm/shared/adm/adm_agent_impl.c
	$(AM_V_at)$(am__mv) nm/shared/adm/$(DEPDIR)/nm_agent-adm_agent_impl.Tpo nm/shared/adm/$(DEPDIR)/nm_agent-adm_agent_impl.Po
#	$(AM_V_CC)source='nm/shared/adm/adm_agent_impl.c' object='nm/shared/adm/nm_agent-adm_agent_impl.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -c -o nm/shared/adm/nm_agent-adm_agent_impl.o `test -f 'nm/shared/adm/adm_agent_impl.c' || echo '$(srcdir)/'`nm/shared/adm/adm_agent_impl.c

nm/shared/adm/nm_agent-adm_agent_impl.obj: nm/shared/adm/adm_agent_impl.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -MT nm/shared/adm/nm_agent-adm_agent_impl.obj -MD -MP -MF nm/shared/adm/$(DEPDIR)/nm_agent-adm_agent_impl.Tpo -c -o nm/shared/adm/nm_agent-adm_agent_impl.obj `if test -f 'nm/shared/adm/adm_agent_impl.c'; then $(CYGPATH_W) 'nm/shared/adm/adm_agent_impl.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/adm/adm_agent_impl.c'; fi`
	$(AM_V_at)$(am__mv) nm/shared/adm/$(DEPDIR)/nm_agent-adm_agent_impl.Tpo nm/shared/adm/$(DEPDIR)/nm_agent-adm_agent_impl.Po
#	$(AM_V_CC)source='nm/shared/adm/adm_agent_impl.c' object='nm/shared/adm/nm_agent-adm_agent_impl.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -c -o nm/shared/adm/nm_agent-adm_agent_impl.obj `if test -f 'nm/shared/adm/adm_agent_impl.c'; then $(CYGPATH_W) 'nm/shared/adm/adm_agent_impl.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/adm/adm_agent_impl.c'; fi`

nm/shared/adm/nm_agent-adm_bp_impl.o: nm/shared/adm/adm_bp_impl.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -MT nm/shared/adm/nm_agent-adm_bp_impl.o -MD -MP -MF nm/shared/adm/$(DEPDIR)/nm_agent-adm_bp_impl.Tpo -c -o nm/shared/adm/nm_agent-adm_bp_impl.o `test -f 'nm/shared/adm/adm_bp_impl.c' || echo '$(srcdir)/'`nm/shared/adm/adm_bp_impl.c
	$(AM_V_at)$(am__mv) nm/shared/adm/$(DEPDIR)/nm_agent-adm_bp_impl.Tpo nm/shared/adm/$(DEPDIR)/nm_agent-adm_bp_impl.Po
#	$(AM_V_CC)source='nm/shared/adm/adm_bp_impl.c' object='nm/shared/adm/nm_agent-adm_bp_impl.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -c -o nm/shared/adm/nm_agent-adm_bp_impl.o `test -f 'nm/shared/adm/adm_bp_impl.c' || echo '$(srcdir)/'`nm/shared/adm/adm_bp_impl.c

nm/shared/adm/nm_agent-adm_bp_impl.obj: nm/shared/adm/adm_bp_impl.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -MT nm/shared/adm/nm_agent-adm_bp_impl.obj -MD -MP -MF nm/shared/adm/$(DEPDIR)/nm_agent-adm_bp_impl.Tpo -c -o nm/shared/adm/nm_agent-adm_bp_impl.obj `if test -f 'nm/shared/adm/adm_bp_impl.c'; then $(CYGPATH_W) 'nm/shared/adm/adm_bp_impl.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/adm/adm_bp_impl.c'; fi`
	$(AM_V_at)$(am__mv) nm/shared/adm/$(DEPDIR)/nm_agent-adm_bp_impl.Tpo nm/shared/adm/$(DEPDIR)/nm_agent-adm_bp_impl.Po
#	$(AM_V_CC)source='nm/shared/adm/adm_bp_impl.c' object='nm/shared/adm/nm_agent-adm_bp_impl.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -c -o nm/shared/adm/nm_agent-adm_bp_impl.obj `if test -f 'nm/shared/adm/adm_bp_impl.c'; then $(CYGPATH_W) 'nm/shared/adm/adm_bp_impl.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/adm/adm_bp_impl.c'; fi`
...
nm/shared/primitives/nm_agent-instr.o: nm/shared/primitives/instr.c
	...
	$(AM_V_at)$(am__mv) nm/shared/primitives/$(DEPDIR)/nm_agent-instr.Tpo nm/shared/primitives/$(DEPDIR)/nm_agent-instr.Po
#	$(AM_V_CC)source='nm/shared/primitives/instr.c' object='nm/shared/primitives/nm_agent-instr.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -c -o nm/shared/primitives/nm_agent-instr.o `test -f 'nm/shared/primitives/instr.c' || echo '$(srcdir)/'`nm/shared/primitives/instr.c

nm/shared/primitives/nm_agent-instr.obj: nm/shared/primitives/instr.c
	...
	$(AM_V_at)$(am__mv) nm/shared/primitives/$(DEPDIR)/nm_agent-instr.Tpo nm/shared/primitives/$(DEPDIR)/nm_agent-instr.Po
#	$(AM_V_CC)source='nm/shared/primitives/instr.c' object='nm/shared/primitives/nm_agent-instr.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -c -o nm/shared/primitives/nm_agent-instr.obj `if test -f 'nm/shared/primitives/instr.c'; then $(CYGPATH_W) 'nm/shared/primitives/instr.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/primitives/instr.c'; fi`
...
nm/shared/adm/nm_mgr-adm_bp_impl.o: nm/shared/adm/adm_bp_impl.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_mgr_CFLAGS) $(CFLAGS) -MT nm/shared/adm/nm_mgr-adm_bp_impl.o -MD -MP -MF nm/shared/adm/$(DEPDIR)/nm_mgr-adm_bp_impl.Tpo -c -o nm/shared/adm/nm_mgr-adm_bp_impl.o `test -f 'nm/shared/adm/adm_bp_impl.c' || echo '$(srcdir)/'`nm/shared/adm/adm_bp_impl.c
	$(AM_V_at)$(am__mv) nm/shared/adm/$(DEPDIR)/nm_mgr-adm_bp_impl.Tpo nm/shared/adm/$(DEPDIR)/nm_mgr-adm_bp_impl.Po
#	$(AM_V_CC)source='nm/shared/adm/adm_bp_impl.c' object='nm/shared/adm/nm_mgr-adm_bp_impl.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_mgr_CFLAGS) $(CFLAGS) -c -o nm/shared/adm/nm_mgr-adm_bp_impl.o `test -f 'nm/shared/adm/adm_bp_impl.c' || echo '$(srcdir)/'`nm/shared/adm/adm_bp_impl.c

nm/shared/adm/nm_mgr-adm_bp_impl.obj: nm/shared/adm/adm_bp_impl.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_mgr_CFLAGS) $(CFLAGS) -MT nm/shared/adm/nm_mgr-adm_bp_impl.obj -MD -MP -MF nm/shared/adm/$(DEPDIR)/nm_mgr-adm_bp_impl.Tpo -c -o nm/shared/adm/nm_mgr-adm_bp_impl.obj `if test -f 'nm/shared/adm/adm_bp_impl.c'; then $(CYGPATH_W) 'nm/shared/adm/adm_bp_impl.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/adm/adm_bp_impl.c'; fi`
	$(AM_V_at)$(am__mv) nm/shared/adm/$(DEPDIR)/nm_mgr-adm_bp_impl.Tpo nm/shared/adm/$(DEPDIR)/nm_mgr-adm_bp_impl.Po
#	$(AM_V_CC)source='nm/shared/adm/adm_bp_impl.c' object='nm/shared/adm/nm_mgr-adm_bp_impl.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_mgr_CFLAGS) $(CFLAGS) -c -o nm/shared/adm/nm_mgr-adm_bp_impl.obj `if test -f 'nm/shared/adm/adm_bp_impl.c'; then $(CYGPATH_W) 'nm/shared/adm/adm_bp_impl.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/adm/adm_bp_impl.c'; fi`
...
nm/shared/primitives/nm_mgr-instr.o: nm/shared/primitives/instr.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_mgr_CFLAGS) $(CFLAGS) -MT nm/shared/primitives/nm_mgr-instr.o -MD -MP -MF nm/shared/primitives/$(DEPDIR)/nm_mgr-instr.Tpo -c -o nm/shared/primitives/nm_mgr-instr.o `test -f 'nm/shared/primitives/instr.c' || echo '$(srcdir)/'`nm/shared/primitives/instr.c
	$(AM_V_at)$(am__mv) nm/shared/primitives/$(DEPDIR)/nm_mgr-instr.Tpo nm/shared/primitives/$(DEPDIR)/nm_mgr-instr.Po
#	$(AM_V_CC)source='nm/shared/primitives/instr.c' object='nm/shared/primitives/nm_mgr-instr.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_mgr_CFLAGS) $(CFLAGS) -c -o nm/shared/primitives/nm_mgr-instr.o `test -f 'nm/shared/primitives/instr.c' || echo '$(srcdir)/'`nm/shared/primitives/instr.c

nm/shared/primitives/nm_mgr-instr.obj: nm/shared/primitives/instr.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_mgr_CFLAGS) $(CFLAGS) -MT nm/shared/primitives/nm_mgr-instr.obj -MD -MP -MF nm/shared/primitives/$(DEPDIR)/nm_mgr-instr.Tpo -c -o nm/shared/primitives/nm_mgr-instr.obj `if test -f 'nm/shared/primitives/instr.c'; then $(CYGPATH_W) 'nm/shared/primitives/instr.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/primitives/instr.c'; fi`
	$(AM_V_at)$(am__mv) nm/shared/primitives/$(DEPDIR)/nm_mgr-instr.Tpo nm/shared/primitives/$(DEPDIR)/nm_mgr-instr.Po
#	$(AM_V_CC)source='nm/shared/primitives/instr.c' object='nm/shared/primitives/nm_mgr-instr.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_mgr_CFLAGS) $(CFLAGS) -c -o nm/shared/primitives/nm_mgr-instr.obj `if test -f 'nm/shared/primitives/instr.c'; then $(CYGPATH_W) 'nm/shared/primitives/instr.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/primitives/instr.c'; fi`
