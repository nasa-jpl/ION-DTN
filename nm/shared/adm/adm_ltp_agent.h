 ...
 * +-----------------------------------------------------------------------------------------------------------+
   ...
   +-----------------------------+------------+--------------------------------------------------+-------------+
 */
#define ADM_LTP_AGENT_META_NAME_ARI_NAME         0x4100
#define ADM_LTP_AGENT_META_NAMESPACE_ARI_NAME    0x4101
#define ADM_LTP_AGENT_META_VERSION_ARI_NAME      0x4102
#define ADM_LTP_AGENT_META_ORGANIZATION_ARI_NAME 0x4103
 ...
 * +-----------------------------------------------------------------------------------------------------------+
   ...
   +-----------------------------+------------+--------------------------------------------------+-------------+
 */
#define ADM_LTP_AGENT_EDD_SPAN_REMOTE_ENGINE_NBR_ARI_NAME   0x4100
#define ADM_LTP_AGENT_EDD_SPAN_CUR_EXPT_SESS_ARI_NAME       0x4101
#define ADM_LTP_AGENT_EDD_SPAN_CUR_OUT_SEG_ARI_NAME         0x4102
#define ADM_LTP_AGENT_EDD_SPAN_CUR_IMP_SESS_ARI_NAME        0x4103
#define ADM_LTP_AGENT_EDD_SPAN_CUR_IN_SEG_ARI_NAME          0x4104
#define ADM_LTP_AGENT_EDD_SPAN_RESET_TIME_ARI_NAME          0x4105
#define ADM_LTP_AGENT_EDD_SPAN_OUT_SEG_Q_CNT_ARI_NAME       0x4106
#define ADM_LTP_AGENT_EDD_SPAN_OUT_SEG_Q_BYTES_ARI_NAME     0x4107
#define ADM_LTP_AGENT_EDD_SPAN_OUT_SEG_POP_CNT_ARI_NAME     0x4108
#define ADM_LTP_AGENT_EDD_SPAN_OUT_SEG_POP_BYTES_ARI_NAME   0x4109
#define ADM_LTP_AGENT_EDD_SPAN_OUT_CKPT_XMIT_CNT_ARI_NAME   0x410a
#define ADM_LTP_AGENT_EDD_SPAN_OUT_POS_ACK_RX_CNT_ARI_NAME  0x410b
#define ADM_LTP_AGENT_EDD_SPAN_OUT_NEG_ACK_RX_CNT_ARI_NAME  0x410c
#define ADM_LTP_AGENT_EDD_SPAN_OUT_CANCEL_RX_CNT_ARI_NAME   0x410d
#define ADM_LTP_AGENT_EDD_SPAN_OUT_CKPT_REXMIT_CNT_ARI_NAME 0x410e
#define ADM_LTP_AGENT_EDD_SPAN_OUT_CANCEL_XMIT_CNT_ARI_NAME 0x410f
#define ADM_LTP_AGENT_EDD_SPAN_OUT_COMPLETE_CNT_ARI_NAME    0x4110
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_RED_CNT_ARI_NAME   0x4111
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_RED_BYTES_ARI_NAME 0x4112
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_GREEN_CNT_ARI_NAME 0x4113
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_GREEN_BYTES_ARI_NAME 0x4114
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_REDUNDANT_CNT_ARI_NAME 0x4115
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_REDUNDANT_BYTES_ARI_NAME 0x4116
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_MAL_CNT_ARI_NAME   0x4117
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_MAL_BYTES_ARI_NAME 0x4118
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_UNK_SENDER_CNT_ARI_NAME 0x4119
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_UNK_SENDER_BYTES_ARI_NAME 0x411a
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_UNK_CLIENT_CNT_ARI_NAME 0x411b
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_UNK_CLIENT_BYTES_ARI_NAME 0x411c
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_STRAY_CNT_ARI_NAME      0x411d
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_STRAY_BYTES_ARI_NAME    0x411e
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_MISCOLOR_CNT_ARI_NAME   0x411f
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_MISCOLOR_BYTES_ARI_NAME 0x4120
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_CLOSED_CNT_ARI_NAME     0x4121
#define ADM_LTP_AGENT_EDD_SPAN_IN_SEG_CLOSED_BYTES_ARI_NAME   0x4122
#define ADM_LTP_AGENT_EDD_SPAN_IN_CKPT_RX_CNT_ARI_NAME        0x4123
#define ADM_LTP_AGENT_EDD_SPAN_IN_POS_ACK_TX_CNT_ARI_NAME     0x4124
#define ADM_LTP_AGENT_EDD_SPAN_IN_NEG_ACK_TX_CNT_ARI_NAME     0x4125
#define ADM_LTP_AGENT_EDD_SPAN_IN_CANCEL_TX_CNT_ARI_NAME      0x4126
#define ADM_LTP_AGENT_EDD_SPAN_IN_ACK_RETX_CNT_ARI_NAME       0x4127
#define ADM_LTP_AGENT_EDD_SPAN_IN_CANCEL_RX_CNT_ARI_NAME      0x4128
#define ADM_LTP_AGENT_EDD_SPAN_IN_COMPLETE_CNT_ARI_NAME       0x4129
 ...
 * +-----------------------------------------------------------------------------------------------------------+
   ...
   +-----------------------------+------------+--------------------------------------------------+-------------+
 */
#define ADM_LTP_AGENT_RPT_ENDPOINTREPORT_ARI_NAME 0x4100
 ...
 * +-----------------------------------------------------------------------------------------------------------+
   ...
   +-----------------------------+------------+--------------------------------------------------+-------------+
 */
#define ADM_LTP_AGENT_CTRL_RESET_ARI_NAME 0x4100
