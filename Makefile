...
am_nm_agent_OBJECTS = nm/agent/nm_agent-ingest.$(OBJEXT) \
	...
	nm/shared/primitives/nm_agent-cd.$(OBJEXT) \
...
am_nm_mgr_OBJECTS = nm/mgr/nm_mgr-nm_mgr.$(OBJEXT) \
	...
	nm/shared/primitives/nm_mgr-cd.$(OBJEXT) \
...
tcpbso_DEPENDENCIES = libbsspP.la libtcpbsa.la libbp.la libici.la \
	$(LIBOBJS)
...
udpbsi_DEPENDENCIES = libbsspP.la libbp.la libici.la $(LIBOBJS)
...
udpbso_DEPENDENCIES = libbsspP.la libbp.la libici.la $(LIBOBJS)
...
ACLOCAL = ${SHELL} /home/ebirrane/ios_3_4_1/ion-open-source/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AM_LIBTOOLFLAGS = 
AR = ar
AUTOCONF = ${SHELL} /home/ebirrane/ios_3_4_1/ion-open-source/missing autoconf
AUTOHEADER = ${SHELL} /home/ebirrane/ios_3_4_1/ion-open-source/missing autoheader
AUTOMAKE = ${SHELL} /home/ebirrane/ios_3_4_1/ion-open-source/missing automake-1.14
AWK = mawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/ebirrane/ios_3_4_1/ion-open-source/missing makeinfo
MANIFEST_TOOL = :
MANOPTS = /usr/bin/man
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
...
PDFJOIN = /home/ebirrane/ios_3_4_1/ion-open-source/doc/pdfjoin
POD_DOCUMENTATION = pod2man
PS2PDF = /usr/bin/ps2pdf
PSJOIN = /home/ebirrane/ios_3_4_1/ion-open-source/doc/psjoin
RANLIB = ranlib
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/bash
...
abs_builddir = /home/ebirrane/ios_3_4_1/ion-open-source
abs_srcdir = /home/ebirrane/ios_3_4_1/ion-open-source
abs_top_builddir = /home/ebirrane/ios_3_4_1/ion-open-source
abs_top_srcdir = /home/ebirrane/ios_3_4_1/ion-open-source
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/ebirrane/ios_3_4_1/ion-open-source/install-sh
...
smrbtsh_LDADD = libici.la $(LIBOBJS)
...
#libbp_la_LIBADD = libici.la $(CRYPTO_LIBS) -lm
...
libbsspP_la_LIBADD = libici.la $(PTHREAD_LIBS)
libbssp_la_SOURCES = \
	bssp/library/libbssp.c \
	bssp/library/libbsspP.c
...
nm_agent_SOURCES = nm/agent/ingest.c            nm/agent/lcc.c                 nm/agent/ldc.c \
					...
					nm/shared/primitives/cd.c 	 nm/shared/primitives/blob.c \
...
nm_mgr_SOURCES = nm/mgr/nm_mgr.c              nm/mgr/nm_mgr_rx.c             nm/mgr/nm_mgr_ui.c \
					...
					nm/shared/msg/msg_admin.c    nm/shared/msg/msg_ctrl.c       nm/shared/msg/pdu.c \
					nm/shared/primitives/cd.c    nm/shared/primitives/expr.c \
					nm/shared/primitives/admin.c nm/shared/primitives/def.c     nm/shared/primitives/mid.c \
					nm/shared/primitives/oid.c   nm/shared/primitives/report.c  nm/shared/primitives/rules.c \
					nm/shared/primitives/dc.c  	 nm/shared/primitives/value.c   nm/shared/primitives/lit.c \
...
nm_mgr_CFLAGS = -I/usr/include -I$(srcdir)/ici/library -I$(srcdir)/bp/library -I$(srcdir)/ltp/library -I$(srcdir)/nm  -I$(srcdir)/nm/mgr $(AM_CFLAGS) -Wno-unused-variable 
...
bp/library/ext/bsp/libbp_la-ciphersuites.lo:  \
	bp/library/ext/bsp/$(am__dirstamp) \
	bp/library/ext/bsp/$(DEPDIR)/$(am__dirstamp)
bp/library/ext/bsp/ciphersuites/$(am__dirstamp):
	@$(MKDIR_P) bp/library/ext/bsp/ciphersuites
	@: > bp/library/ext/bsp/ciphersuites/$(am__dirstamp)
bp/library/ext/bsp/ciphersuites/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) bp/library/ext/bsp/ciphersuites/$(DEPDIR)
	@: > bp/library/ext/bsp/ciphersuites/$(DEPDIR)/$(am__dirstamp)
bp/library/ext/bsp/ciphersuites/libbp_la-bab_hmac_sha1.lo:  \
	bp/library/ext/bsp/ciphersuites/$(am__dirstamp) \
	bp/library/ext/bsp/ciphersuites/$(DEPDIR)/$(am__dirstamp)
...
mostlyclean-compile:
	...
	-rm -f bp/library/ext/bsp/*.$(OBJEXT)
	-rm -f bp/library/ext/bsp/*.lo
	-rm -f bp/library/ext/bsp/ciphersuites/*.$(OBJEXT)
	-rm -f bp/library/ext/bsp/ciphersuites/*.lo
...
include bp/library/ext/bsp/$(DEPDIR)/libbp_la-bspbab.Plo
include bp/library/ext/bsp/$(DEPDIR)/libbp_la-bspbcb.Plo
include bp/library/ext/bsp/$(DEPDIR)/libbp_la-bspbib.Plo
include bp/library/ext/bsp/$(DEPDIR)/libbp_la-bsputil.Plo
include bp/library/ext/bsp/$(DEPDIR)/libbp_la-ciphersuites.Plo
include bp/library/ext/bsp/ciphersuites/$(DEPDIR)/libbp_la-bab_hmac_sha1.Plo
include bp/library/ext/bsp/ciphersuites/$(DEPDIR)/libbp_la-bcb_arc4.Plo
include bp/library/ext/bsp/ciphersuites/$(DEPDIR)/libbp_la-bib_hmac_sha256.Plo
...
include nm/shared/primitives/$(DEPDIR)/nm_agent-cd.Po
...
include nm/shared/primitives/$(DEPDIR)/nm_mgr-cd.Po
...
bp/library/ext/bsp/libbp_la-bspbab.lo: bp/library/ext/bsp/bspbab.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -MT bp/library/ext/bsp/libbp_la-bspbab.lo -MD -MP -MF bp/library/ext/bsp/$(DEPDIR)/libbp_la-bspbab.Tpo -c -o bp/library/ext/bsp/libbp_la-bspbab.lo `test -f 'bp/library/ext/bsp/bspbab.c' || echo '$(srcdir)/'`bp/library/ext/bsp/bspbab.c
	$(AM_V_at)$(am__mv) bp/library/ext/bsp/$(DEPDIR)/libbp_la-bspbab.Tpo bp/library/ext/bsp/$(DEPDIR)/libbp_la-bspbab.Plo
#	$(AM_V_CC)source='bp/library/ext/bsp/bspbab.c' object='bp/library/ext/bsp/libbp_la-bspbab.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bsp/libbp_la-bspbab.lo `test -f 'bp/library/ext/bsp/bspbab.c' || echo '$(srcdir)/'`bp/library/ext/bsp/bspbab.c

bp/library/ext/bsp/libbp_la-bspbcb.lo: bp/library/ext/bsp/bspbcb.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -MT bp/library/ext/bsp/libbp_la-bspbcb.lo -MD -MP -MF bp/library/ext/bsp/$(DEPDIR)/libbp_la-bspbcb.Tpo -c -o bp/library/ext/bsp/libbp_la-bspbcb.lo `test -f 'bp/library/ext/bsp/bspbcb.c' || echo '$(srcdir)/'`bp/library/ext/bsp/bspbcb.c
	$(AM_V_at)$(am__mv) bp/library/ext/bsp/$(DEPDIR)/libbp_la-bspbcb.Tpo bp/library/ext/bsp/$(DEPDIR)/libbp_la-bspbcb.Plo
#	$(AM_V_CC)source='bp/library/ext/bsp/bspbcb.c' object='bp/library/ext/bsp/libbp_la-bspbcb.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bsp/libbp_la-bspbcb.lo `test -f 'bp/library/ext/bsp/bspbcb.c' || echo '$(srcdir)/'`bp/library/ext/bsp/bspbcb.c

bp/library/ext/bsp/libbp_la-bspbib.lo: bp/library/ext/bsp/bspbib.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -MT bp/library/ext/bsp/libbp_la-bspbib.lo -MD -MP -MF bp/library/ext/bsp/$(DEPDIR)/libbp_la-bspbib.Tpo -c -o bp/library/ext/bsp/libbp_la-bspbib.lo `test -f 'bp/library/ext/bsp/bspbib.c' || echo '$(srcdir)/'`bp/library/ext/bsp/bspbib.c
	$(AM_V_at)$(am__mv) bp/library/ext/bsp/$(DEPDIR)/libbp_la-bspbib.Tpo bp/library/ext/bsp/$(DEPDIR)/libbp_la-bspbib.Plo
#	$(AM_V_CC)source='bp/library/ext/bsp/bspbib.c' object='bp/library/ext/bsp/libbp_la-bspbib.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bsp/libbp_la-bspbib.lo `test -f 'bp/library/ext/bsp/bspbib.c' || echo '$(srcdir)/'`bp/library/ext/bsp/bspbib.c

bp/library/ext/bsp/libbp_la-bsputil.lo: bp/library/ext/bsp/bsputil.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -MT bp/library/ext/bsp/libbp_la-bsputil.lo -MD -MP -MF bp/library/ext/bsp/$(DEPDIR)/libbp_la-bsputil.Tpo -c -o bp/library/ext/bsp/libbp_la-bsputil.lo `test -f 'bp/library/ext/bsp/bsputil.c' || echo '$(srcdir)/'`bp/library/ext/bsp/bsputil.c
	$(AM_V_at)$(am__mv) bp/library/ext/bsp/$(DEPDIR)/libbp_la-bsputil.Tpo bp/library/ext/bsp/$(DEPDIR)/libbp_la-bsputil.Plo
#	$(AM_V_CC)source='bp/library/ext/bsp/bsputil.c' object='bp/library/ext/bsp/libbp_la-bsputil.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bsp/libbp_la-bsputil.lo `test -f 'bp/library/ext/bsp/bsputil.c' || echo '$(srcdir)/'`bp/library/ext/bsp/bsputil.c

bp/library/ext/bsp/libbp_la-ciphersuites.lo: bp/library/ext/bsp/ciphersuites.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -MT bp/library/ext/bsp/libbp_la-ciphersuites.lo -MD -MP -MF bp/library/ext/bsp/$(DEPDIR)/libbp_la-ciphersuites.Tpo -c -o bp/library/ext/bsp/libbp_la-ciphersuites.lo `test -f 'bp/library/ext/bsp/ciphersuites.c' || echo '$(srcdir)/'`bp/library/ext/bsp/ciphersuites.c
	$(AM_V_at)$(am__mv) bp/library/ext/bsp/$(DEPDIR)/libbp_la-ciphersuites.Tpo bp/library/ext/bsp/$(DEPDIR)/libbp_la-ciphersuites.Plo
#	$(AM_V_CC)source='bp/library/ext/bsp/ciphersuites.c' object='bp/library/ext/bsp/libbp_la-ciphersuites.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bsp/libbp_la-ciphersuites.lo `test -f 'bp/library/ext/bsp/ciphersuites.c' || echo '$(srcdir)/'`bp/library/ext/bsp/ciphersuites.c

bp/library/ext/bsp/ciphersuites/libbp_la-bab_hmac_sha1.lo: bp/library/ext/bsp/ciphersuites/bab_hmac_sha1.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -MT bp/library/ext/bsp/ciphersuites/libbp_la-bab_hmac_sha1.lo -MD -MP -MF bp/library/ext/bsp/ciphersuites/$(DEPDIR)/libbp_la-bab_hmac_sha1.Tpo -c -o bp/library/ext/bsp/ciphersuites/libbp_la-bab_hmac_sha1.lo `test -f 'bp/library/ext/bsp/ciphersuites/bab_hmac_sha1.c' || echo '$(srcdir)/'`bp/library/ext/bsp/ciphersuites/bab_hmac_sha1.c
	$(AM_V_at)$(am__mv) bp/library/ext/bsp/ciphersuites/$(DEPDIR)/libbp_la-bab_hmac_sha1.Tpo bp/library/ext/bsp/ciphersuites/$(DEPDIR)/libbp_la-bab_hmac_sha1.Plo
#	$(AM_V_CC)source='bp/library/ext/bsp/ciphersuites/bab_hmac_sha1.c' object='bp/library/ext/bsp/ciphersuites/libbp_la-bab_hmac_sha1.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
bp/library/ext/bsp/ciphersuites/libbp_la-bcb_arc4.lo: bp/library/ext/bsp/ciphersuites/bcb_arc4.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -MT bp/library/ext/bsp/ciphersuites/libbp_la-bcb_arc4.lo -MD -MP -MF bp/library/ext/bsp/ciphersuites/$(DEPDIR)/libbp_la-bcb_arc4.Tpo -c -o bp/library/ext/bsp/ciphersuites/libbp_la-bcb_arc4.lo `test -f 'bp/library/ext/bsp/ciphersuites/bcb_arc4.c' || echo '$(srcdir)/'`bp/library/ext/bsp/ciphersuites/bcb_arc4.c
	$(AM_V_at)$(am__mv) bp/library/ext/bsp/ciphersuites/$(DEPDIR)/libbp_la-bcb_arc4.Tpo bp/library/ext/bsp/ciphersuites/$(DEPDIR)/libbp_la-bcb_arc4.Plo
#	$(AM_V_CC)source='bp/library/ext/bsp/ciphersuites/bcb_arc4.c' object='bp/library/ext/bsp/ciphersuites/libbp_la-bcb_arc4.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bsp/ciphersuites/libbp_la-bcb_arc4.lo `test -f 'bp/library/ext/bsp/ciphersuites/bcb_arc4.c' || echo '$(srcdir)/'`bp/library/ext/bsp/ciphersuites/bcb_arc4.c

bp/library/ext/bsp/ciphersuites/libbp_la-bib_hmac_sha256.lo: bp/library/ext/bsp/ciphersuites/bib_hmac_sha256.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -MT bp/library/ext/bsp/ciphersuites/libbp_la-bib_hmac_sha256.lo -MD -MP -MF bp/library/ext/bsp/ciphersuites/$(DEPDIR)/libbp_la-bib_hmac_sha256.Tpo -c -o bp/library/ext/bsp/ciphersuites/libbp_la-bib_hmac_sha256.lo `test -f 'bp/library/ext/bsp/ciphersuites/bib_hmac_sha256.c' || echo '$(srcdir)/'`bp/library/ext/bsp/ciphersuites/bib_hmac_sha256.c
	$(AM_V_at)$(am__mv) bp/library/ext/bsp/ciphersuites/$(DEPDIR)/libbp_la-bib_hmac_sha256.Tpo bp/library/ext/bsp/ciphersuites/$(DEPDIR)/libbp_la-bib_hmac_sha256.Plo
#	$(AM_V_CC)source='bp/library/ext/bsp/ciphersuites/bib_hmac_sha256.c' object='bp/library/ext/bsp/ciphersuites/libbp_la-bib_hmac_sha256.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bsp/ciphersuites/libbp_la-bib_hmac_sha256.lo `test -f 'bp/library/ext/bsp/ciphersuites/bib_hmac_sha256.c' || echo '$(srcdir)/'`bp/library/ext/bsp/ciphersuites/bib_hmac_sha256.c
...
nm/shared/primitives/nm_agent-cd.o: nm/shared/primitives/cd.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -MT nm/shared/primitives/nm_agent-cd.o -MD -MP -MF nm/shared/primitives/$(DEPDIR)/nm_agent-cd.Tpo -c -o nm/shared/primitives/nm_agent-cd.o `test -f 'nm/shared/primitives/cd.c' || echo '$(srcdir)/'`nm/shared/primitives/cd.c
	$(AM_V_at)$(am__mv) nm/shared/primitives/$(DEPDIR)/nm_agent-cd.Tpo nm/shared/primitives/$(DEPDIR)/nm_agent-cd.Po
#	$(AM_V_CC)source='nm/shared/primitives/cd.c' object='nm/shared/primitives/nm_agent-cd.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -c -o nm/shared/primitives/nm_agent-cd.o `test -f 'nm/shared/primitives/cd.c' || echo '$(srcdir)/'`nm/shared/primitives/cd.c

nm/shared/primitives/nm_agent-cd.obj: nm/shared/primitives/cd.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -MT nm/shared/primitives/nm_agent-cd.obj -MD -MP -MF nm/shared/primitives/$(DEPDIR)/nm_agent-cd.Tpo -c -o nm/shared/primitives/nm_agent-cd.obj `if test -f 'nm/shared/primitives/cd.c'; then $(CYGPATH_W) 'nm/shared/primitives/cd.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/primitives/cd.c'; fi`
	$(AM_V_at)$(am__mv) nm/shared/primitives/$(DEPDIR)/nm_agent-cd.Tpo nm/shared/primitives/$(DEPDIR)/nm_agent-cd.Po
#	$(AM_V_CC)source='nm/shared/primitives/cd.c' object='nm/shared/primitives/nm_agent-cd.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -c -o nm/shared/primitives/nm_agent-cd.obj `if test -f 'nm/shared/primitives/cd.c'; then $(CYGPATH_W) 'nm/shared/primitives/cd.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/primitives/cd.c'; fi`
...
nm/shared/primitives/nm_mgr-cd.o: nm/shared/primitives/cd.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_mgr_CFLAGS) $(CFLAGS) -MT nm/shared/primitives/nm_mgr-cd.o -MD -MP -MF nm/shared/primitives/$(DEPDIR)/nm_mgr-cd.Tpo -c -o nm/shared/primitives/nm_mgr-cd.o `test -f 'nm/shared/primitives/cd.c' || echo '$(srcdir)/'`nm/shared/primitives/cd.c
	$(AM_V_at)$(am__mv) nm/shared/primitives/$(DEPDIR)/nm_mgr-cd.Tpo nm/shared/primitives/$(DEPDIR)/nm_mgr-cd.Po
#	$(AM_V_CC)source='nm/shared/primitives/cd.c' object='nm/shared/primitives/nm_mgr-cd.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_mgr_CFLAGS) $(CFLAGS) -c -o nm/shared/primitives/nm_mgr-cd.o `test -f 'nm/shared/primitives/cd.c' || echo '$(srcdir)/'`nm/shared/primitives/cd.c

nm/shared/primitives/nm_mgr-cd.obj: nm/shared/primitives/cd.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_mgr_CFLAGS) $(CFLAGS) -MT nm/shared/primitives/nm_mgr-cd.obj -MD -MP -MF nm/shared/primitives/$(DEPDIR)/nm_mgr-cd.Tpo -c -o nm/shared/primitives/nm_mgr-cd.obj `if test -f 'nm/shared/primitives/cd.c'; then $(CYGPATH_W) 'nm/shared/primitives/cd.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/primitives/cd.c'; fi`
	$(AM_V_at)$(am__mv) nm/shared/primitives/$(DEPDIR)/nm_mgr-cd.Tpo nm/shared/primitives/$(DEPDIR)/nm_mgr-cd.Po
#	$(AM_V_CC)source='nm/shared/primitives/cd.c' object='nm/shared/primitives/nm_mgr-cd.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_mgr_CFLAGS) $(CFLAGS) -c -o nm/shared/primitives/nm_mgr-cd.obj `if test -f 'nm/shared/primitives/cd.c'; then $(CYGPATH_W) 'nm/shared/primitives/cd.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/primitives/cd.c'; fi`
...
clean-libtool:
	...
	-rm -rf bp/library/ext/bsp/ciphersuites/.libs bp/library/ext/bsp/ciphersuites/_libs
...
distclean-generic:
	...
	-rm -f bp/library/ext/bsp/ciphersuites/$(DEPDIR)/$(am__dirstamp)
	-rm -f bp/library/ext/bsp/ciphersuites/$(am__dirstamp)
