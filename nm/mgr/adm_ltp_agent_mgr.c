...
{
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_REMOTE_ENGINE_NBR_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_CUR_EXPT_SESS_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	names_add_name("SPAN_CUR_EXPT_SESS", "Expected sessions on this span.", ADM_LTP_AGENT, ADM_LTP_AGENT_EDD_SPAN_CUR_EXPT_SESS_MID);

	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_CUR_OUT_SEG_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_CUR_IMP_SESS_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_CUR_IN_SEG_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_RESET_TIME_MID, AMP_TYPE_UVAST, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_OUT_SEG_Q_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_OUT_SEG_Q_BYTES_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_OUT_SEG_POP_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_OUT_SEG_POP_BYTES_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_OUT_CKPT_XMIT_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_OUT_POS_ACK_RX_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_OUT_NEG_ACK_RX_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_OUT_CANCEL_RX_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_OUT_CKPT_REXMIT_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_OUT_CANCEL_XMIT_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_OUT_COMPLETE_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_RED_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_RED_BYTES_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_GREEN_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_GREEN_BYTES_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_REDUNDANT_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_REDUNDANT_BYTES_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_MAL_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_MAL_BYTES_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_UNK_SENDER_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_UNK_SENDER_BYTES_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_UNK_CLIENT_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_RX_UNK_CLIENT_BYTES_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_STRAY_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_STRAY_BYTES_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_MISCOLOR_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_MISCOLOR_BYTES_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_CLOSED_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_SEG_CLOSED_BYTES_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_CKPT_RX_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_POS_ACK_TX_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_NEG_ACK_TX_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_CANCEL_TX_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_ACK_RETX_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_CANCEL_RX_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_LTP_AGENT_EDD_SPAN_IN_COMPLETE_CNT_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
...
{
	adm_add_ctrl(ADM_LTP_AGENT_CTRL_RESET_MID, NULL);
	...
	adm_add_ctrl(ADM_LTP_AGENT_CTRL_LIST_ENGINES_MID, NULL);
...
void adm_ltp_agent_init_metadata()
{
	...
	adm_add_edd(ADM_LTP_AGENT_META_NAME_MID, AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("NAME", "The human-readable name of the ADM.", ADM_LTP_AGENT, ADM_LTP_AGENT_META_NAME_MID);
	adm_add_edd(ADM_LTP_AGENT_META_NAMESPACE_MID, AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("NAMESPACE", "The namespace of the ADM.", ADM_LTP_AGENT, ADM_LTP_AGENT_META_NAMESPACE_MID);
	adm_add_edd(ADM_LTP_AGENT_META_VERSION_MID, AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("VERSION", "The version of the ADM.", ADM_LTP_AGENT, ADM_LTP_AGENT_META_VERSION_MID);
	adm_add_edd(ADM_LTP_AGENT_META_ORGANIZATION_MID, AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
...
void adm_ltp_agent_init_reports()
{
	uint32_t used= 0;
		...
		names_add_name("ADM_LTP_AGENT_RPT_ENDPOINTREPORT_MID", "This is all known endpoint information", ADM_LTP_AGENT, ADM_LTP_AGENT_RPT_ENDPOINTREPORT_MID);
