...
/*	Args are pointer-sized (saddr), not int: pseudoshell passes task
 *	argument string pointers through here, and on 64-bit RTEMS targets
 *	(e.g. riscv rv64, aarch64) int would truncate them.		*/
