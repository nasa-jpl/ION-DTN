...
protocol), and on for non-BSS traffic.  These default duct expressions may
...
=item a rule 18 * 9 tcp/saturn.nasa.gov:5011 udp/*,saturn.nasa.gov:5012 tcp/neptune.nasa.gov:5011
