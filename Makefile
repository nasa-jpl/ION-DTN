...
ACLOCAL = ${SHELL} /export/home/irgadmin/repo_stuff/test/ion-open-source_int3.1.2/missing --run aclocal-1.11
AMTAR = ${SHELL} /export/home/irgadmin/repo_stuff/test/ion-open-source_int3.1.2/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /export/home/irgadmin/repo_stuff/test/ion-open-source_int3.1.2/missing --run autoconf
AUTOHEADER = ${SHELL} /export/home/irgadmin/repo_stuff/test/ion-open-source_int3.1.2/missing --run autoheader
AUTOMAKE = ${SHELL} /export/home/irgadmin/repo_stuff/test/ion-open-source_int3.1.2/missing --run automake-1.11
AWK = nawk
CC = gcc
...
ION_CFLAGS =  -Dsol -Dunix -D__SVR4 -D_REENTRANT -fno-strict-aliasing -fno-builtin -DSPACE_ORDER=3 -m64
ION_LINK_FLAGS = -lrt -lsocket -lnsl
LD = /usr/ccs/bin/ld
LDFLAGS = 
LIBOBJS = 
LIBS = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /export/home/irgadmin/repo_stuff/test/ion-open-source_int3.1.2/missing --run makeinfo
MANIFEST_TOOL = :
MANOPTS = /usr/bin/man
...
PATH_SEPARATOR = :
PDF2PS = /usr/sfw/bin/pdf2ps
POD_DOCUMENTATION = pod2man
PS2PDF = /usr/sfw/bin/ps2pdf
PSJOIN = /export/home/irgadmin/repo_stuff/test/ion-open-source_int3.1.2/doc/psjoin
...
abs_builddir = /export/home/irgadmin/repo_stuff/test/ion-open-source_int3.1.2
abs_srcdir = /export/home/irgadmin/repo_stuff/test/ion-open-source_int3.1.2
abs_top_builddir = /export/home/irgadmin/repo_stuff/test/ion-open-source_int3.1.2
abs_top_srcdir = /export/home/irgadmin/repo_stuff/test/ion-open-source_int3.1.2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /export/home/irgadmin/repo_stuff/test/ion-open-source_int3.1.2/install-sh
...
ltpcli_LDADD = libipnfw.la libbssfw.la libdtn2fw.la libbp.la libltp.la libici.la $(LIBOBJS) 
...
tcpcli_LDADD = libipnfw.la libbssfw.la libdtn2fw.la libbp.la libtcpcla.la libici.la $(LIBOBJS) 
...
stcpcli_LDADD = libipnfw.la libbssfw.la libdtn2fw.la libbp.la libtcpcla.la libici.la $(LIBOBJS) 
...
udpcli_LDADD = libipnfw.la libbssfw.la libdtn2fw.la libbp.la libudpcla.la libici.la $(LIBOBJS) 
...
dccpcli_LDADD = libipnfw.la libbssfw.la libdtn2fw.la libbp.la libici.la $(LIBOBJS) 
...
dgrcla_LDADD = libipnfw.la libbssfw.la libdtn2fw.la libbp.la libdgr.la libici.la $(LIBOBJS) 
dgrcla_CFLAGS = $(bpcflags) $(AM_CFLAGS)

# --- BRS executables --- #
brsscla_SOURCES = bp/brs/brsscla.c
brsscla_LDADD = libipnfw.la libbssfw.la libdtn2fw.la libbp.la libtcpcla.la libici.la $(LIBOBJS) 
brsscla_CFLAGS = $(bpcflags) $(AM_CFLAGS)
brsccla_SOURCES = bp/brs/brsccla.c
brsccla_LDADD = libipnfw.la libbssfw.la libdtn2fw.la libbp.la libtcpcla.la libici.la $(LIBOBJS) 
...
bpcp_LDADD = libcfdp.la libici.la $(LIBOBJS)
