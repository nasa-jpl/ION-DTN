...
For debugging and monitoring, see [standard-operating-procedure.md](standard-operating-procedure.md), [monitoring-guide.md](monitoring-guide.md), and [watch-characters.md](watch-characters.md) for standard operating procedures, monitoring techniques, and watch character interpretation.
...
**Important:** Read [testset-readme.md](testset-readme.md) for test creation instructions.
...
- **Multi-node Operation**: If you need to operate multiple ION nodes on the same host machine, you must read [deployment-guide.md](deployment-guide.md) for the required configuration instructions, such as setting the `ION_NODE_LIST_DIR` environment variable.
