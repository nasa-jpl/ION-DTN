...
{
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_ENDPOINTADD_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_ENDPOINTCHANGE_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_ENDPOINTDEL_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_INDUCTADD_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_INDUCTCHANGE_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_INDUCTDEL_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_INDUCTSTART_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_INDUCTSTOP_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_MANAGEHEAPMAX_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_OUTDUCTADD_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_OUTDUCTCHANGE_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_OUTDUCTDEL_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_OUTDUCTSTART_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_OUTDUCTBLOCK_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_OUTDUCTUNBLOCK_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_OUTDUCTSTOP_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_PROTOCOLADD_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_PROTOCOLDEL_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_PROTOCOLSTART_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_PROTOCOLSTOP_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_SCHEMEADD_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_SCHEMECHANGE_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_SCHEMEDEL_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_SCHEMESTART_MID), NULL);
	...
	adm_add_ctrl(mid_from_value(ADM_ION_BP_ADMIN_CTRL_SCHEMESTOP_MID), NULL);
