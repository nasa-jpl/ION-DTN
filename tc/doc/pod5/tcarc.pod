...
I<multicast_group_number_for_TC_bulletins> identifies the multicast
group that the members of this collective authority will use for the
exchange of proposed information bulletins.

I<multicast_group_number_for_TC_records> identifies the multicast group
that the members of this collective authority will use for the publication
of "blocks" of information on which they have reached consensus.  NOTE: as
such, it identifies the TC application served by this collective authority.
...
The B<info> command will print information about the current state
...
=item B<+> I<authority_array_index> I<node_identifier>
...
value, is the node identified by I<node_identifer>.

NOTE: "node_identifier" is the node-identifying string that would appear
in the BP node ID for this node as formed in the ipn URI scheme.
...
=item B<a> I<node_identifier>

This command adds the node identified by I<node_identifier> to the list of
nodes hosting B<authorized_clients> for the selected TC application.  Once this
...
=item B<d> I<node_identifier>

This command deletes the node identified by I<node_identifier> from the list
of nodes hosting B<authorized_clients> for the selected TC application.
