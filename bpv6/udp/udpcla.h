...
/* dual-stack with automatic shutdown handling */
...
extern int  receiveUdpClaDatagram(UdpClaSocket *claSock, char *buffer,
                 ...
                 int *is_shutdown);
extern int  sendUdpClaDatagram(UdpClaSocket *claSock, const char *data,
                 size_t length, const IonNetworkAddress *dest_addr);
