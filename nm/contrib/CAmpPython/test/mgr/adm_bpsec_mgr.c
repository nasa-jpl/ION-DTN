...
void adm_bpsec_init_reports()
{
	...
	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_TX_BCB_BLK_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_TX_BCB_BLK_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_RX_BCB_BLK_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_RX_BCB_BLK_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_MISSING_RX_BCB_BLKS_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_FWD_BCB_BLKS_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_TX_BCB_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_TX_BCB_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_RX_BCB_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_RX_BCB_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_MISSING_RX_BCB_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_FWD_BCB_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_TX_BIB_BLKS_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_TX_BIB_BLKS_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_RX_BIB_BLKS_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_RX_BIB_BLKS_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_MISS_RX_BIB_BLKS_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_FWD_BIB_BLKS_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_TX_BIB_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_TX_BIB_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_RX_BIB_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_RX_BIB_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_MISS_RX_BIB_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_FWD_BIB_BYTES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_LAST_UPDATE_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_KNOWN_KEYS_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_KEY_NAMES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_CIPHERSUITE_NAMES_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_RULE_SOURCE_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);
...
rpt = lyst_create();
	...
	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_TX_BCB_BLKS_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_TX_BCB_BLKS_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_RX_BCB_BLKS_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_RX_BCB_BLKS_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_MISSING_RX_BCB_BLKS_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_FWD_BCB_BLKS_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_TX_BCB_BYTES_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_TX_BCB_BYTES_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_RX_BCB_BYTES_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_RX_BCB_BYTES_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_MISSING_RX_BCB_BYTES_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_FWD_BCB_BYTES_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_TX_BIB_BLKS_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_TX_BIB_BLKS_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_RX_BIB_BLKS_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_RX_BIB_BLKS_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_MISS_RX_BIB_BLKS_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_FWD_BIB_BLKS_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_TX_BIB_BYTES_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_TX_BIB_BYTES_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_GOOD_RX_BIB_BYTES_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_BAD_RX_BIB_BYTES_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_MISSING_RX_BIB_BYTES_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_NUM_FWD_BIB_BYTES_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_LAST_UPDATE_SRC_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);

	cur_mid = mid_from_value(ADM_BPSEC_EDD_LAST_RESET_MID);
	cur_item = rpttpl_item_create(cur_mid, 0);
	lyst_insert_last(rpt,cur_item);
