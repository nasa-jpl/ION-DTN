...
extern vec_idx_t g_dtn_ion_ionsecadmin_idx[11];
 ...
 * +---------------------+--------------+--------------------------------------+-------+------------------------+
 * |name                 |448018aa00    |The human-readable name of the ADM.   |STR    |ionsec_admin            |
 * +---------------------+--------------+--------------------------------------+-------+------------------------+
 * |namespace            |448018aa01    |The namespace of the ADM.             |STR    |DTN/ION/ionsecadmin     |
 * +---------------------+--------------+--------------------------------------+-------+------------------------+
 * |version              |448018aa02    |The version of the ADM.               |STR    |v0.0                    |
 * +---------------------+--------------+--------------------------------------+-------+------------------------+
 * |organization         |448018aa03    |The name of the issuing organization o|       |                        |
 ...
 * |        NAME         |     ARI      |             DESCRIPTION              | TYPE  |
 * +---------------------+--------------+--------------------------------------+-------+
 * |ltp_rx_rules         |448a18a700    |This table lists all LTP segment authe|       |
 * |                     |              |ntication rulesin the security policy |       |
 * |                     |              |database.                             |       |
 * +---------------------+--------------+--------------------------------------+-------+
 * |ltp_tx_rules         |448a18a701    |This table lists all LTP segment signi|       |
 ...
 * |        NAME         |     ARI      |             DESCRIPTION              | TYPE  |
 * +---------------------+--------------+--------------------------------------+-------+
 * |key_add              |44c118a100    |This control adds a named key value to|       |
 ...
 * |                     |              |olicy database.                       |       |
 * +---------------------+--------------+--------------------------------------+-------+
 * |key_change           |44c118a101    |This control changes the value of the |       |
 * |                     |              |named key, obtaining the new key value|       |
 * |                     |              | from the content of file_name.       |       |
 * +---------------------+--------------+--------------------------------------+-------+
 * |key_del              |44c118a102    |This control deletes the key identifie|       |
 * |                     |              |d by name.                            |       |
 * +---------------------+--------------+--------------------------------------+-------+
 * |ltp_rx_rule_add      |44c118a103    |This control adds a rule specifying th|       |
 ...
 * |                     |              |: NULL                                |       |
 * +---------------------+--------------+--------------------------------------+-------+
 * |ltp_rx_rule_change   |44c118a104    |This control changes the parameters of|       |
 * |                     |              | the LTP segment authentication rule f|       |
 * |                     |              |or the indicated LTP engine.          |       |
 * +---------------------+--------------+--------------------------------------+-------+
 * |ltp_rx_rule_del      |44c118a105    |This control deletes the LTP segment a|       |
 * |                     |              |uthentication rule for the indicated L|       |
 * |                     |              |TP engine.                            |       |
 * +---------------------+--------------+--------------------------------------+-------+
 * |ltp_tx_rule_add      |44c118a106    |This control adds a rule specifying th|       |
 ...
 * +---------------------+--------------+--------------------------------------+-------+
 * |ltp_tx_rule_change   |44c118a107    |This control changes the parameters of|       |
 * |                     |              | the LTP segment signing rule for the |       |
 * |                     |              |indicated LTP engine.                 |       |
 * +---------------------+--------------+--------------------------------------+-------+
 * |ltp_tx_rule_del      |44c118a108    |This control deletes the LTP segment s|       |
 * |                     |              |igning rule forthe indicated LTP engin|       |
 * |                     |              |e.                                    |       |
 * +---------------------+--------------+--------------------------------------+-------+
 * |list_keys            |448118a109    |This control lists the names of keys a|       |
 * |                     |              |vailable in the key policy database.  |       |
 * +---------------------+--------------+--------------------------------------+-------+
 * |list_ltp_rx_rules    |448118a10a    |This control lists all LTP segment aut|       |
 * |                     |              |hentication rules in the security poli|       |
 * |                     |              |cy database.                          |       |
 * +---------------------+--------------+--------------------------------------+-------+
 * |list_ltp_tx_rules    |448118a10b    |This control lists all LTP segment sig|       |
