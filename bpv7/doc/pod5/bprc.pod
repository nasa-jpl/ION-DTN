...
NOTE: Both primary and payload CRC types for bundles being relayed will preserve
the original setting by the source node, not impacted by these settings.
