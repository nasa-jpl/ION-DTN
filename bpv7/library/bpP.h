...
#define BDL_IS_FRAGMENT		(1)	/*	00000000 00000001	*/
#define BDL_IS_ADMIN		(2)	/*	00000000 00000010	*/
#define BDL_DOES_NOT_FRAGMENT	(4)	/*	00000000 00000100	*/
#define BDL_APP_ACK_REQUEST	(32)	/*	00000000 00100000	*/
#define BDL_STATUS_TIME_REQ	(64)	/*	00000000 01000000	*/
#define BDL_RECEIVED_RPT_REQ	(256)	/*	00000001 00000000	*/
#define BDL_FORWARDED_RPT_REQ	(1024)	/*	00000100 00000000	*/
#define BDL_DELIVERED_RPT_REQ	(2048)	/*	00001000 00000000	*/
#define BDL_DELETED_RPT_REQ	(4096)	/*	00010000 00000000	*/

/*	Block processing flags						*/
#define BLK_MUST_BE_COPIED	(1)	/*	00000001		*/
#define BLK_REMOVE_IF_NG	(2)	/*	00000010		*/
#define BLK_REPORT_IF_NG	(4)	/*	00000100		*/
#define BLK_ABORT_IF_NG		(8)	/*	00001000		*/
