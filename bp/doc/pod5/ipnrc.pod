...
"group" and "grouprule" continue to be accepted by ipnadmin as aliases
for the new keywords "exit" and "exitrule", but the older terminology is
deprecated.
...
=head1 EXITRULE COMMANDS

=over 4

=item B<a exitrule> I<first_node_nbr> I<last_node_nbr> I<qualifier> I<gateway_endpoint_ID>

The B<add exitrule> command.  This command establishes an exitrule, i.e.,
a gateway endpoint ID that overrides the default gateway endpoint ID of the
exit identified by I<first_node_nbr> and I<last_node_nbr> in the event
that the source endpoint ID of the subject bundle matches I<qualifier>.

=item B<c exitrule> I<first_node_nbr> I<last_node_nbr> I<qualifier> I<gateway_endpoint_ID>

The B<change exitrule> command.  This command changes the gateway EID
for the indicated exitrule.

=item B<d exitrule> I<first_node_nbr> I<last_node_nbr> I<qualifier>

The B<delete exitrule> command.  This command deletes the exitrule identified
by I<first_node_nbr>, I<last_node_nbr>, and I<qualifier>.

=item B<i exitrule> I<first_node_nbr> I<last_node_nbr> I<qualifier>
...
=item B<l exitrule> I<first_node_nbr> I<last_node_nbr>
...
=item a planrule 18 * 9 tcp/119.31.01.18:4016
...
on TCP outduct 119.31.01.18:4016 rather than the default (transmission
on LTP outduct 18).
