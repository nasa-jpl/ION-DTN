...
=item void sdr_read(Sdr sdr, char *into, Address from, size_t length)
...
=item void sdr_write(Sdr sdr, Address into, char *from, size_t length)
...
=item void *sdr_pointer(Sdr sdr, Address address)
...
=item Address sdr_address(Sdr sdr, void *pointer)
...
=item Object sdr_malloc(Sdr sdr, size_t size)
...
=item Object sdr_insert(Sdr sdr, char *from, size_t size)
...
=item size_t sdr_object_length(Sdr sdr, Object object)
...
=item void sdr_stage(Sdr sdr, char *into, Object from, size_t length)
