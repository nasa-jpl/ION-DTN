...
I<class_of_service> is I<custody-requested>.I<priority>[.I<ordinal>[.I<unreliable>.I<critical>[.I<flow-label>]]],
...
(Boolean), and I<flow-label> may be any unsigned integer.  I<custody-requested>
...
I<ordinal> is ignored if I<priority> is not 2.  Setting I<class_of_service> to
