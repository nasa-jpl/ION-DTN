...
void adm_bpsec_init_edd()
{
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_BAD_TX_BCB_BLKS_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_GOOD_RX_BCB_BLKS_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_BAD_RX_BCB_BLKS_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_MISSING_RX_BCB_BLKS_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_FWD_BCB_BLKS_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_GOOD_TX_BCB_BYTES_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_BAD_TX_BCB_BYTES_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_GOOD_RX_BCB_BYTES_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_BAD_RX_BCB_BYTES_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_MISSING_RX_BCB_BYTES_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_FWD_BCB_BYTES_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_GOOD_TX_BIB_BLKS_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_BAD_TX_BIB_BLKS_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_GOOD_RX_BIB_BLKS_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_BAD_RX_BIB_BLKS_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_MISS_RX_BIB_BLKS_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_FWD_BIB_BLKS_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_GOOD_TX_BIB_BYTES_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_BAD_TX_BIB_BYTES_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_GOOD_RX_BIB_BYTES_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_BAD_RX_BIB_BYTES_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_MISSING_RX_BIB_BYTES_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_NUM_FWD_BIB_BYTES_SRC_MID, AMP_TYPE_UINT, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_LAST_UPDATE_SRC_MID, AMP_TYPE_TS, 0, NULL, NULL, NULL);
	...
	adm_add_edd(ADM_BPSEC_EDD_LAST_RESET_MID, AMP_TYPE_TS, 0, NULL, NULL, NULL);
...
{
	adm_add_var(ADM_BPSEC_VAR_TOTAL_BAD_TX_BLKS_MID, NULL);
...
{
	adm_add_ctrl(ADM_BPSEC_CTRL_RST_ALL_CNTS_MID, NULL);
	...
	adm_add_ctrl(ADM_BPSEC_CTRL_RST_SRC_CNTS_MID, NULL);
	...
	adm_add_ctrl(ADM_BPSEC_CTRL_DELETE_KEY_MID, NULL);
	...
	adm_add_ctrl(ADM_BPSEC_CTRL_ADD_KEY_MID, NULL);
	...
	adm_add_ctrl(ADM_BPSEC_CTRL_ADD_BIB_RULE_MID, NULL);
	...
	adm_add_ctrl(ADM_BPSEC_CTRL_DEL_BIB_RULE_MID, NULL);
	...
	adm_add_ctrl(ADM_BPSEC_CTRL_LIST_BIB_RULES_MID, NULL);
	...
	adm_add_ctrl(ADM_BPSEC_CTRL_ADD_BCB_RULE_MID, NULL);
	...
	adm_add_ctrl(ADM_BPSEC_CTRL_DEL_BCB_RULE_MID, NULL);
	...
	adm_add_ctrl(ADM_BPSEC_CTRL_LIST_BCB_RULES_MID, NULL);
...
{
	adm_add_macro(ADM_BPSEC_MACRO_RST_ALL_CNTS_TWICE_MID, NULL);
		names_add_name("RST_ALL_CNTS_TWICE", "This macro resets counts twice.", ADM_BPSEC, ADM_BPSEC_MACRO_RST_ALL_CNTS_TWICE_MID);

	adm_add_macro(ADM_BPSEC_MACRO_RST_SRC_CNTS_TWICE_MID, NULL);
		names_add_name("RST_SRC_CNTS_TWICE", "This macro resets counts twice.", ADM_BPSEC, ADM_BPSEC_MACRO_RST_SRC_CNTS_TWICE_MID);
...
void adm_bpsec_init_metadata()
{
	...
	adm_add_edd(ADM_BPSEC_META_NAME_MID, AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("NAME", "The human-readable name of the ADM.", ADM_BPSEC, ADM_BPSEC_META_NAME_MID);
	adm_add_edd(ADM_BPSEC_META_NAMESPACE_MID, AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("NAMESPACE", "The namespace of the ADM.", ADM_BPSEC, ADM_BPSEC_META_NAMESPACE_MID);
	adm_add_edd(ADM_BPSEC_META_VERSION_MID, AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
	names_add_name("VERSION", "The version of the ADM.", ADM_BPSEC, ADM_BPSEC_META_VERSION_MID);
	adm_add_edd(ADM_BPSEC_META_ORGANIZATION_MID, AMP_TYPE_STR, 0, NULL, adm_print_string, adm_size_string);
