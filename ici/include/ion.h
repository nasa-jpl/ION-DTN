...
/* As of 2012-1-23 the sourceforge version number is this: */
#define IONVERSIONNUMBER "2.5.3"
#endif
...
typedef struct
{
	...
	Scalar		occupancyCeiling;
	Scalar		maxForecastOccupancy;
	Scalar		reserveForInTransit;
