 ...
 * +-----------------------------------------------------------------------------------------------------------+
   ...
   +-----------------------------+------------+--------------------------------------------------+-------------+
   |exit_rule_add                |0xc3400103  |This control adds an exit rule.                   |             |
   +-----------------------------+------------+--------------------------------------------------+-------------+
   |exit_rule_change             |0xc3400104  |This control changes an exit rule.                |             |
   +-----------------------------+------------+--------------------------------------------------+-------------+
   |exit_rule_del                |0xc3400105  |This control deletes an exit rule.                |             |
   +-----------------------------+------------+--------------------------------------------------+-------------+
   |plan_add                     |0xc3400106  |This control establishes an egress plan for the bu|             |
   |                             |            |ndles that must be transmitted to the neighboring |             |
   |                             |            |node that is identified by it's nodeNbr.          |             |
   +-----------------------------+------------+--------------------------------------------------+-------------+
   |plan_change                  |0xc3400107  |This control changes the duct expression for the i|             |
   |                             |            |ndicated plan.                                    |             |
   +-----------------------------+------------+--------------------------------------------------+-------------+
   |plan_del                     |0xc3400108  |This control deletes the egress plan for the node |             |
   |                             |            |that is identified by it's nodeNbr.               |             |
   +-----------------------------+------------+--------------------------------------------------+-------------+
   |plan_rule_add                |0xc3400109  |This control adds a plan rule.                    |             |
   +-----------------------------+------------+--------------------------------------------------+-------------+
   |plan_rule_change             |0xc340010a  |This control changes the plan rule.               |             |
   +-----------------------------+------------+--------------------------------------------------+-------------+
   |plan_rule_del                |0xc340010b  |This control deletes a plan rule.                 |             |
   +-----------------------------+------------+--------------------------------------------------+-------------+
 */
...
#define ADM_ION_IPN_ADMIN_CTRL_EXIT_RULE_ADD_MID 0xc3400103
#define ADM_ION_IPN_ADMIN_CTRL_EXIT_RULE_CHANGE_MID 0xc3400104
#define ADM_ION_IPN_ADMIN_CTRL_EXIT_RULE_DEL_MID 0xc3400105
#define ADM_ION_IPN_ADMIN_CTRL_PLAN_ADD_MID 0xc3400106
#define ADM_ION_IPN_ADMIN_CTRL_PLAN_CHANGE_MID 0xc3400107
#define ADM_ION_IPN_ADMIN_CTRL_PLAN_DEL_MID 0xc3400108
#define ADM_ION_IPN_ADMIN_CTRL_PLAN_RULE_ADD_MID 0xc3400109
#define ADM_ION_IPN_ADMIN_CTRL_PLAN_RULE_CHANGE_MID 0xc340010a
#define ADM_ION_IPN_ADMIN_CTRL_PLAN_RULE_DEL_MID 0xc340010b
