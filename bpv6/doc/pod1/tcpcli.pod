...
B<tcpcli> is a background "daemon" task comprising 1 + 2*N threads: one that
handles TCP connections from remote B<tcpclo> tasks, spawning sockets for
