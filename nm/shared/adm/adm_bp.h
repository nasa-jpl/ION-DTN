...
#define BP_ADM_MD_NN_STR "0x2B060102030100"

#define BP_ADM_AD_NN_IDX 11
#define BP_ADM_AD_NN_STR "0x2B060102030101"

#define BP_ADM_CD_NN_IDX 12
#define BP_ADM_CD_NN_STR "0x2B060102030102"

#define BP_ADM_RPT_NN_IDX 13
#define BP_ADM_RPT_NN_STR "0x2B060102030103"

#define BP_ADM_CTRL_NN_IDX 14
#define BP_ADM_CTRL_NN_STR "0x2B060102030104"

#define BP_ADM_LTRL_NN_IDX 15
#define BP_ADM_LTRL_NN_STR "0x2B060102030105"

#define BP_ADM_MAC_NN_IDX 16
#define BP_ADM_MAC_NN_STR "0x2B060102030106"

#define BP_ADM_OP_NN_IDX 17
#define BP_ADM_OP_NN_STR "0x2B060102030107"

#define BP_ADM_ROOT_NN_IDX 18
#define BP_ADM_ROOT_NN_STR "0x2B0601020301"
 ...
 * +--------------------------------------------------------------------------+
   ...
   |    Name    |   MID    |   OID   |   Description    |     Type     |
   +------------+----------+---------+------------------+--------------+
   | BundleRpt  | 880D0100 | [13].0  |  Report of all   |      DC      |
   |            |          |         |   Bundle data    |              |
   |            |          |         |                  |              |
   | EndpointRpt| 880D0101 | [13].1  | All Endpoint Info|      DC      |
   +------------+----------+---------+------------------+--------------+
 */

#define ADM_BP_RPT_FULL_MID   "880D0100"
#define ADM_BP_ENDPT_FULL_MID "880D0101"
 ...
 * +--------------------------------------------------------------------------+
   ...
   +----------------+-----------+----------+---------------------------+
   | Reset BP Counts| 810E0100  | [14].0   | Resets all BP counters.   |
   +----------------+-----------+----------+---------------------------+
*/

#define ADM_BP_CTL_RESET_BP_COUNTS "810E0100"
