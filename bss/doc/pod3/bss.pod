...
the directory in which the database resides.  I<eid> is ignored.  On 
failure to open database, returns -1.  On detection of existing opened database,
keep existing database open, returns -2. On success, returns 0.
