...
DTPC transmission profile.  A transmission profile asserts the BP and DTPC
...
The startup-test command.  Reports whether the DTPC entity is started and sets
