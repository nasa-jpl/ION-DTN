...
=item char *istrcpy(char *buffer, char *sourceString, int bufSize)
...
=item char *istrcat(char *buffer, char *sourceString, int bufSize)
...
=item void postErrmsg(char *text, char *argument)
...
=item void postSysErrmsg(char *text, char *arg)
