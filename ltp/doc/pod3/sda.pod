...
=head1 SYNOPSIS
    ...
    typedef int (*SdaHandlerFn)(uvast sourceEngineId, unsigned int clientId,
...
=item int sda_send(uvast destinationEngineId, unsigned int clientId,
SdrObject clientServiceData)
