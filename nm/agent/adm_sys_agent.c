...
void dtn_sys_init_edd(void)
{
	...
	adm_add_edd(adm_build_ari(AMP_TYPE_EDD, 0, g_dtn_sys_idx[ADM_EDD_IDX], DTN_SYS_EDD_MEM_TOTAL_BYTES), dtn_sys_get_mem_total_bytes);
	adm_add_edd(adm_build_ari(AMP_TYPE_EDD, 0, g_dtn_sys_idx[ADM_EDD_IDX], DTN_SYS_EDD_MEM_FREE_BYTES), dtn_sys_get_mem_free_bytes);
	adm_add_edd(adm_build_ari(AMP_TYPE_EDD, 0, g_dtn_sys_idx[ADM_EDD_IDX], DTN_SYS_EDD_MEM_USED_BYTES), dtn_sys_get_mem_used_bytes);
	adm_add_edd(adm_build_ari(AMP_TYPE_EDD, 0, g_dtn_sys_idx[ADM_EDD_IDX], DTN_SYS_EDD_SWAP_TOTAL_BYTES), dtn_sys_get_swap_total_bytes);
	adm_add_edd(adm_build_ari(AMP_TYPE_EDD, 0, g_dtn_sys_idx[ADM_EDD_IDX], DTN_SYS_EDD_SWAP_FREE_BYTES), dtn_sys_get_swap_free_bytes);
	adm_add_edd(adm_build_ari(AMP_TYPE_EDD, 0, g_dtn_sys_idx[ADM_EDD_IDX], DTN_SYS_EDD_DISK_TOTAL_BYTES), dtn_sys_get_disk_total_bytes);
	adm_add_edd(adm_build_ari(AMP_TYPE_EDD, 0, g_dtn_sys_idx[ADM_EDD_IDX], DTN_SYS_EDD_DISK_FREE_BYTES), dtn_sys_get_disk_free_bytes);
	adm_add_edd(adm_build_ari(AMP_TYPE_EDD, 0, g_dtn_sys_idx[ADM_EDD_IDX], DTN_SYS_EDD_DISK_USED_BYTES), dtn_sys_get_disk_used_bytes);
